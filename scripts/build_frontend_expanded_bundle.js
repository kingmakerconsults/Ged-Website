...
const workspaceRoot = __dirname.replace(/\\scripts$/, '');
...
function main() {
  ...
  for (const entry of entries) {
    ...
    // Create containers
    const subj = setNested(data, [subjectKey], { icon: null, categories: {} });
    const cat = setNested(subj, ['categories', categoryName], { description: '', topics: [] });
