                ...
                topics: [
                    {
                        ...
                        quizzes: [
                            ...
                            },
                            {
                                ...
                                label: "Quiz B",
                                questions: [
                                    { questionNumber: 1, type: 'text', passage: `<div class="passage-text"><b>Organelle Summary</b><table class="w-full text-left mt-2"><thead><tr class="border-b"><th class="p-2">Organelle</th><th class="p-2">Primary Function</th></tr></thead><tbody><tr class="border-b"><td class="p-2">Mitochondria</td><td class="p-2">Generates ATP for the cell</td></tr><tr class="border-b"><td class="p-2">Vacuole</td><td class="p-2">Stores water and nutrients</td></tr><tr class="border-b"><td class="p-2">Cell membrane</td><td class="p-2">Selectively permeable barrier</td></tr><tr class="border-b"><td class="p-2">Nucleus</td><td class="p-2">—</td></tr></tbody></table></div>`, question: "Based on the organelle summary, what is the primary function of a cell's nucleus?", answerOptions: [ { text: "To store water and nutrients.", rationale: "This is the function of vacuoles.", isCorrect: false }, { text: "To control the cell's activities and store genetic information.", rationale: "Correct. The nucleus is the control center of the cell.", isCorrect: true }, { text: "To provide energy for the cell.", rationale: "This is the function of the mitochondria.", isCorrect: false }, { text: "To protect the cell from its surroundings.", rationale: "This is the function of the cell membrane.", isCorrect: false } ] },
                                    { questionNumber: 2, type: 'text', passage: `<div class="passage-text"><b>Cellular Respiration (simplified)</b><div class="mt-2">C6H12O6 + 6O2 → 6CO2 + 6H2O + ATP (energy)</div></div>`, question: "According to the equation above, what are the products of cellular respiration?", answerOptions: [ { text: "Glucose and oxygen.", rationale: "These are the reactants of cellular respiration.", isCorrect: false }, { text: "Carbon dioxide, water, and ATP (energy).", rationale: "Correct. Cellular respiration breaks down glucose to produce energy.", isCorrect: true }, { text: "Sunlight and water.", rationale: "These are reactants of photosynthesis.", isCorrect: false }, { text: "Lactic acid and alcohol.", rationale: "These are products of fermentation, a type of anaerobic respiration.", isCorrect: false } ] },
                                    { questionNumber: 3, type: 'text', passage: `<div class="passage-text"><b>Semipermeable Membrane Model</b><div class="mt-2">A membrane separates two solutions. Side A has 10% solute, Side B has 1% solute. The membrane allows only water to pass.</div></div>`, question: "Based on the model, which description best defines the process of osmosis?", answerOptions: [ { text: "The movement of molecules from an area of high concentration to an area of low concentration.", rationale: "This is the definition of diffusion.", isCorrect: false }, { text: "The movement of water across a semipermeable membrane.", rationale: "Correct. Osmosis is the diffusion of water.", isCorrect: true }, { text: "The use of energy to move molecules against a concentration gradient.", rationale: "This is active transport.", isCorrect: false }, { text: "The process of a cell engulfing a large particle.", rationale: "This is endocytosis.", isCorrect: false } ] },
                                    { questionNumber: 4, type: 'text', passage: `<div class="passage-text"><b>Protein Synthesis Snapshot</b><ul class="list-disc ml-5"><li>mRNA carries instructions from DNA</li><li>Ribosomes read mRNA codons</li><li>Amino acids are linked into polypeptides</li></ul></div>`, question: "In the process summarized above, which cellular structure performs the primary role?", answerOptions: [ { text: "To produce proteins.", rationale: "Correct. Ribosomes are the sites of protein synthesis.", isCorrect: true }, { text: "To store the cell's genetic material.", rationale: "This is the function of the nucleus.", isCorrect: false }, { text: "To break down waste materials.", rationale: "This is the function of lysosomes.", isCorrect: false }, { text: "To package and transport proteins.", rationale: "This is the function of the Golgi apparatus.", isCorrect: false } ] },
                                    { questionNumber: 5, type: 'text', passage: `<div class="passage-text"><b>Levels of Organization</b><table class="w-full text-left mt-2"><thead><tr class="border-b"><th class="p-2">Level</th><th class="p-2">Example</th></tr></thead><tbody><tr class="border-b"><td class="p-2">Cell</td><td class="p-2">Muscle cell</td></tr><tr class="border-b"><td class="p-2">—</td><td class="p-2">Muscle tissue</td></tr><tr class="border-b"><td class="p-2">Organ</td><td class="p-2">Heart</td></tr></tbody></table></div>`, question: "Which term correctly completes the second row?", answerOptions: [ { text: "Organ.", rationale: "An organ is a group of tissues.", isCorrect: false }, { text: "Tissue.", rationale: "Correct. A tissue is a group of similar cells.", isCorrect: true }, { text: "Organism.", rationale: "An organism is a complete living being.", isCorrect: false }, { text: "Organ system.", rationale: "An organ system is a group of organs.", isCorrect: false } ] },
                                    { questionNumber: 6, type: 'text', passage: `<div class="passage-text">A plant bends toward a window where light is present. A single-celled organism swims away from a drop of vinegar added to the slide.</div>`, question: "Which universal characteristic of life is illustrated by the examples above?", answerOptions: [ { text: "The ability to move.", rationale: "Not all living things move (e.g., plants).", isCorrect: false }, { text: "The ability to respond to stimuli.", rationale: "Correct. All living things react to changes in their environment.", isCorrect: true }, { text: "The ability to perform photosynthesis.", rationale: "Only plants, algae, and some bacteria perform photosynthesis.", isCorrect: false }, { text: "The ability to see.", rationale: "Not all living things can see.", isCorrect: false } ] },
                                    { questionNumber: 7, type: 'text', passage: `<div class="passage-text"><b>Plant vs. Animal Cells</b><table class="w-full text-left mt-2"><thead><tr class="border-b"><th class="p-2">Feature</th><th class="p-2">Plant Cell</th><th class="p-2">Animal Cell</th></tr></thead><tbody><tr class="border-b"><td class="p-2">Cell wall</td><td class="p-2">Present</td><td class="p-2">Absent</td></tr><tr class="border-b"><td class="p-2">Large central vacuole</td><td class="p-2">Common</td><td class="p-2">Rare</td></tr></tbody></table></div>`, question: "Based on the table, what is the main purpose of the plant cell wall?", answerOptions: [ { text: "To regulate what enters and leaves the cell.", rationale: "This is the function of the cell membrane.", isCorrect: false }, { text: "To provide structural support and protection.", rationale: "Correct. The cell wall is a rigid layer that gives plant cells their shape.", isCorrect: true }, { text: "To store water.", rationale: "This is the function of the vacuole.", isCorrect: false }, { text: "To produce energy.", rationale: "This is the function of the mitochondria.", isCorrect: false } ] },
                                    { questionNumber: 8, type: 'text', passage: `<div class="passage-text"><b>Cell Types at a Glance</b><table class="w-full text-left mt-2"><thead><tr class="border-b"><th class="p-2">Feature</th><th class="p-2">Prokaryote</th><th class="p-2">Eukaryote</th></tr></thead><tbody><tr class="border-b"><td class="p-2">Nucleus</td><td class="p-2">Absent</td><td class="p-2">Present</td></tr><tr class="border-b"><td class="p-2">Membrane-bound organelles</td><td class="p-2">No</td><td class="p-2">Yes</td></tr></tbody></table></div>`, question: "Which statement correctly compares prokaryotic and eukaryotic cells?", answerOptions: [ { text: "Prokaryotic cells have a nucleus, while eukaryotic cells do not.", rationale: "This is the opposite of the correct answer.", isCorrect: false }, { text: "Eukaryotic cells have a nucleus and membrane-bound organelles, while prokaryotic cells do not.", rationale: "Correct. This is the primary distinction between the two cell types.", isCorrect: true }, { text: "Prokaryotic cells are always larger than eukaryotic cells.", rationale: "Eukaryotic cells are generally larger.", isCorrect: false }, { text: "Eukaryotic cells are only found in plants, while prokaryotic cells are found in animals.", rationale: "Both plants and animals have eukaryotic cells.", isCorrect: false } ] },
                                    { questionNumber: 9, type: 'text', passage: `<div class="passage-text"><b>Cell Division Overview</b><ul class="list-disc ml-5"><li>Growth and repair of tissues</li><li>Daughter cells identical to parent</li><li>One division</li></ul></div>`, question: "Which process matches the overview above?", answerOptions: [ { text: "Meiosis.", rationale: "Meiosis produces four genetically different cells.", isCorrect: false }, { text: "Mitosis.", rationale: "Correct. Mitosis is the process of cell division for growth and repair.", isCorrect: true }, { text: "Fertilization.", rationale: "Fertilization is the fusion of gametes.", isCorrect: false }, { text: "Transcription.", rationale: "Transcription is the process of creating RNA from DNA.", isCorrect: false } ] },
                                    { questionNumber: 10, type: 'text', passage: `<div class="passage-text">A microscope view shows a single prokaryotic cell dividing by binary fission.</div>`, question: "Which of the following is an example of a unicellular organism?", answerOptions: [ { text: "A mushroom.", rationale: "Mushrooms are multicellular.", isCorrect: false }, { text: "A human.", rationale: "Humans are multicellular.", isCorrect: false }, { text: "A bacterium.", rationale: "Correct. Bacteria are single-celled organisms.", isCorrect: true }, { text: "A tree.", rationale: "Trees are multicellular.", isCorrect: false } ] },
                                    { questionNumber: 11, type: 'text', passage: `<div class="passage-text"><b>Leaf Pigment</b><div class="mt-2">This green pigment absorbs red and blue wavelengths of light to power photosynthesis.</div></div>`, question: "Which pigment does the description refer to?", answerOptions: [ { text: "Hemoglobin.", rationale: "Hemoglobin is the pigment in red blood cells that carries oxygen.", isCorrect: false }, { text: "Chlorophyll.", rationale: "Correct. Chlorophyll absorbs light energy for photosynthesis.", isCorrect: true }, { text: "Melanin.", rationale: "Melanin is the pigment that gives skin its color.", isCorrect: false }, { text: "Carotene.", rationale: "Carotene is a pigment that gives some plants their orange color.", isCorrect: false } ] },
                                    { questionNumber: 12, type: 'text', passage: `<div class="passage-text"><b>Cell Boundary</b><div class="mt-2">A selectively permeable phospholipid bilayer controls the movement of materials into and out of the cell.</div></div>`, question: "Which of the following is a function of the structure described above?", answerOptions: [ { text: "To produce proteins.", rationale: "This is the function of ribosomes.", isCorrect: false }, { text: "To control what enters and leaves the cell.", rationale: "Correct. The cell membrane is selectively permeable.", isCorrect: true }, { text: "To store the cell's genetic information.", rationale: "This is the function of the nucleus.", isCorrect: false }, { text: "To provide rigid support for the cell.", rationale: "This is the function of the cell wall in plants.", isCorrect: false } ] },
                                    { questionNumber: 13, type: 'text', passage: `<div class="passage-text">In the food web below, wolves eat deer and rabbits; deer eat plants. Wolves cannot photosynthesize.</div>`, question: "What is the term for an organism that cannot make its own food and must consume other organisms for energy?", answerOptions: [ { text: "Autotroph.", rationale: "Autotrophs, like plants, make their own food.", isCorrect: false }, { text: "Heterotroph.", rationale: "Correct. Heterotrophs are consumers.", isCorrect: true }, { text: "Producer.", rationale: "Producers, like plants, make their own food.", isCorrect: false }, { text: "Decomposer.", rationale: "Decomposers break down dead organic matter.", isCorrect: false } ] },
                                    { questionNumber: 14, type: 'text', passage: `<div class="passage-text"><b>Photosynthesis (balanced)</b><div class="mt-2">6CO2 + 6H2O + light → C6H12O6 + 6O2</div></div>`, question: "According to the equation, which substance is released as a waste product of photosynthesis?", answerOptions: [ { text: "Carbon dioxide.", rationale: "Carbon dioxide is a reactant in photosynthesis.", isCorrect: false }, { text: "Water.", rationale: "Water is a reactant in photosynthesis.", isCorrect: false }, { text: "Oxygen.", rationale: "Correct. Oxygen is released as a byproduct of photosynthesis.", isCorrect: true }, { text: "Glucose.", rationale: "Glucose is the food produced by photosynthesis.", isCorrect: false } ] },
                                    { questionNumber: 15, type: 'text', passage: `<div class="passage-text"><b>Macromolecules & Monomers</b><table class="w-full text-left mt-2"><thead><tr class="border-b"><th class="p-2">Macromolecule</th><th class="p-2">Monomer (building block)</th></tr></thead><tbody><tr class="border-b"><td class="p-2">Carbohydrate</td><td class="p-2">Monosaccharide</td></tr><tr class="border-b"><td class="p-2">Protein</td><td class="p-2">—</td></tr><tr class="border-b"><td class="p-2">Nucleic Acid</td><td class="p-2">Nucleotide</td></tr></tbody></table></div>`, question: "Which monomer correctly completes the table for proteins?", answerOptions: [ { text: "Nucleic acids.", rationale: "Nucleic acids are the building blocks of DNA and RNA.", isCorrect: false }, { text: "Amino acids.", rationale: "Correct. Proteins are polymers of amino acids.", isCorrect: true }, { text: "Lipids.", rationale: "Lipids are fats.", isCorrect: false }, { text: "Carbohydrates.", rationale: "Carbohydrates are sugars.", isCorrect: false } ] }
                                ]
                            },
                            {
                        ...
                        quizzes: [
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 15, type: 'knowledge', question: "The concept of a 'carbon footprint' refers to what?", answerOptions: [ { text: "The total amount of carbon stored in the soil.", rationale: "This is part of the carbon cycle, but not a carbon footprint.", isCorrect: false }, { text: "The total amount of greenhouse gases generated by our actions.", rationale: "Correct. It is a measure of an individual's or organization's impact on the climate.", isCorrect: true }, { text: "The physical mark left by carbon-based life forms.", rationale: "This is a literal interpretation, not the correct meaning.", isCorrect: false }, { text: "The number of trees planted to offset carbon emissions.", rationale: "This is a way to reduce a carbon footprint, not the footprint itself.", isCorrect: false } ] }
                                ]
                            },
                            {
                                ...
                                label: "Quiz B",
                                questions: [
                                    { questionNumber: 1, type: 'text', passage: "A wildlife biologist counts 48 white-tailed deer within a fenced nature reserve. The group interbreeds and shares the same habitat.", question: "What is the term for a group of organisms of the same species living in the same area?", answerOptions: [ { text: "Community.", rationale: "A community includes all the different species in an area.", isCorrect: false }, { text: "Population.", rationale: "Correct. A population is a group of individuals of the same species.", isCorrect: true }, { text: "Ecosystem.", rationale: "An ecosystem includes all living and non-living factors.", isCorrect: false }, { text: "Biome.", rationale: "A biome is a large-scale community of organisms, such as a desert or forest.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 4, type: 'text', passage: "Certain soil bacteria convert atmospheric N2 into ammonia (NH3) in plant root nodules, allowing legumes to grow in nitrogen-poor soils.", question: "What is the process by which nitrogen is converted into a usable form for plants?", answerOptions: [ { text: "Nitrogen fixation.", rationale: "Correct. Nitrogen fixation is the process by which atmospheric nitrogen is converted into ammonia, which plants can use.", isCorrect: true }, { text: "Denitrification.", rationale: "Denitrification is the process by which nitrates are converted back into nitrogen gas.", isCorrect: false }, { text: "Nitrification.", rationale: "Nitrification is the process by which ammonia is converted into nitrates.", isCorrect: false }, { text: "Ammonification.", rationale: "Ammonification is the process by which organic nitrogen is converted into ammonia.", isCorrect: false } ] },
                        ...
                        quizzes: [
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 10, type: 'knowledge', question: "If an organism has two identical alleles for a particular trait, it is said to be what?", answerOptions: [ { text: "Homozygous", rationale: "Correct. For example, 'BB' or 'bb'.", isCorrect: true }, { text: "Heterozygous", rationale: "Heterozygous means having two different alleles, like 'Bb'.", isCorrect: false }, { text: "Dominant", rationale: "Dominant refers to an allele, not the combination of alleles.", isCorrect: false }, { text: "Recessive", rationale: "Recessive refers to an allele, not the combination of alleles.", isCorrect: false } ] },
                            ...
                            },
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 5, type: 'knowledge', question: "The process of making an identical copy of a DNA molecule is called what?", answerOptions: [ { text: "Replication", rationale: "Correct. DNA replication occurs before cell division.", isCorrect: true }, { text: "Transcription", rationale: "Transcription is the process of making RNA from DNA.", isCorrect: false }, { text: "Translation", rationale: "Translation is the process of making a protein from RNA.", isCorrect: false }, { text: "Mutation", rationale: "A mutation is a change in the DNA sequence.", isCorrect: false } ] },
                                    { questionNumber: 6, type: 'knowledge', question: "A chart that shows the inheritance of a trait over several generations is called what?", answerOptions: [ { text: "Pedigree chart", rationale: "Correct. Pedigree charts are used to track genetic disorders.", isCorrect: true }, { text: "Punnett square", rationale: "A Punnett square predicts the outcome of a single cross.", isCorrect: false }, { text: "Karyotype", rationale: "A karyotype shows an individual's chromosomes.", isCorrect: false }, { text: "DNA fingerprint", rationale: "A DNA fingerprint is a technique used to identify individuals.", isCorrect: false } ] },
                                    { questionNumber: 7, type: 'knowledge', question: "The genetic makeup of an organism is called what?", answerOptions: [ { text: "Genotype", rationale: "Correct. The genotype is the set of genes in an organism's DNA.", isCorrect: true }, { text: "Phenotype", rationale: "The phenotype is the physical expression of the genotype.", isCorrect: false }, { text: "Genome", rationale: "The genome is the complete set of genetic material.", isCorrect: false }, { text: "Chromosome", rationale: "A chromosome is a structure that contains DNA.", isCorrect: false } ] },
                                    { questionNumber: 8, type: 'text', passage: "At a ribosome, the sequence of codons on an mRNA strand is read to assemble amino acids into a polypeptide chain. tRNA molecules bring specific amino acids that match each codon.", question: "What is the process of converting the information in mRNA into a protein?", answerOptions: [ { text: "Translation", rationale: "Correct. This process occurs in the ribosomes.", isCorrect: true }, { text: "Transcription", rationale: "Transcription is the process of making RNA from DNA.", isCorrect: false }, { text: "Replication", rationale: "Replication is the process of copying DNA.", isCorrect: false }, { text: "Mutation", rationale: "A mutation is a change in the DNA sequence.", isCorrect: false } ] },
                            ...
                            },
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 12, type: 'text', passage: "A lab technician stains and photographs condensed chromosomes from a human cell, arranging them by size and shape to check for extra or missing copies.", question: "What is a karyotype?", answerOptions: [ { text: "A picture of an individual's chromosomes.", rationale: "Correct. A karyotype can be used to diagnose chromosomal abnormalities.", isCorrect: true }, { text: "A type of cell.", rationale: "A karyotype is a property of a cell, but not the cell itself.", isCorrect: false }, { text: "A genetic disease.", rationale: "A karyotype can be used to diagnose a genetic disease, but is not the disease itself.", isCorrect: false }, { text: "A type of protein.", rationale: "Proteins are made based on instructions from genes.", isCorrect: false } ] },
                        ...
                        quizzes: [
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 6, type: 'image', imageUrl: "Images/Science/ged-scince-fig-8.png", question: "If the person pushes the box with a force of 50 Newtons and the box moves 5 meters, how much work has been done?", answerOptions: [ { text: "10 Joules", rationale: "Work is calculated as Force x Distance, not Force / Distance.", isCorrect: false }, { text: "250 Joules", rationale: "Correct. Work = 50 N * 5 m = 250 J.", isCorrect: true }, { text: "55 Joules", rationale: "This is the sum of the force and distance, not the product.", isCorrect: false }, { text: "0 Joules", rationale: "Work is done because the box moved.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 11, type: 'knowledge', question: "According to Newton's second law of motion, if you double the force on an object, its acceleration will do what?", answerOptions: [ { text: "Double", rationale: "Correct. Acceleration is directly proportional to force (F=ma).", isCorrect: true }, { text: "Be cut in half", rationale: "This would be true if you doubled the mass.", isCorrect: false }, { text: "Remain the same", rationale: "The acceleration will change if the force changes.", isCorrect: false }, { text: "Be quadrupled", rationale: "This is not the correct relationship.", isCorrect: false } ] },
                            ...
                            },
                            {
                                ...
                                label: "Quiz C",
                                questions: [
                                    { questionNumber: 1, type: 'text', passage: "A magnet attracts a paperclip; a car engine pushes the vehicle forward; a gust of wind changes a kite's motion. Each interaction involves an influence that can change motion.", question: "A force is a:", answerOptions: [ { text: "Push or a pull", rationale: "Correct. A force can cause an object to accelerate.", isCorrect: true }, { text: "Property of matter", rationale: "This is a description of inertia or mass.", isCorrect: false }, { text: "Measure of energy", rationale: "Energy is the ability to do work.", isCorrect: false }, { text: "Change in position", rationale: "This is displacement or movement.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 11, type: "text", passage: "Inside an evacuated chamber where air has been removed, objects fall without air resistance. Consider dropping a bowling ball and a feather from the same height.", question: "If you drop a bowling ball and a feather from the same height in a vacuum, which will hit the ground first?", answerOptions: [ { text: "The bowling ball", rationale: "In a vacuum, there is no air resistance, so all objects fall at the same rate.", isCorrect: false }, { text: "The feather", rationale: "In a vacuum, there is no air resistance, so all objects fall at the same rate.", isCorrect: false }, { text: "They will hit the ground at the same time.", rationale: "Correct. This is because the acceleration due to gravity is the same for all objects, regardless of their mass.", isCorrect: true }, { text: "It is impossible to tell.", rationale: "It is possible to tell based on the principles of physics.", isCorrect: false } ] },
