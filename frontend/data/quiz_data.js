                        ...
                        quizzes: [
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 3, type: "applied", question: "Maria bought 3 notebooks for \$2.75 each. What was the total cost?", answerOptions: [ { text: "\$6.75", rationale: "This multiplies \$2.25 by 3 instead of \$2.75.", isCorrect: false }, { text: "\$7.25", rationale: "This underestimates the cost by \$1.00.", isCorrect: false }, { text: "\$8.25", rationale: "Correct. 3 \\times \$2.75 = \$8.25.", isCorrect: true }, { text: "\$8.75", rationale: "This adds an extra \$0.50 to the correct amount.", isCorrect: false } ] },
                            ...
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 10, type: "applied", question: "A store adds an 8% sales tax to a \$150 purchase. How much is the total cost?", answerOptions: [ { text: "\$158", rationale: "This assumes the tax is \$8 rather than \$12.", isCorrect: false }, { text: "\$162", rationale: "Correct. Add the \$12 tax to get \$162.", isCorrect: true }, { text: "\$164", rationale: "This treats the tax as \$14.", isCorrect: false }, { text: "\$168", rationale: "This doubles the tax rate.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 12, type: "applied", question: "A bicycle is on sale for 25% off the original price of \$240. What is the sale price?", answerOptions: [ { text: "\$120", rationale: "This is a 50% discount, not 25%.", isCorrect: false }, { text: "\$160", rationale: "This subtracts \$80, which is more than 25%.", isCorrect: false }, { text: "\$180", rationale: "Correct. \$240 - \$60 = \$180.", isCorrect: true }, { text: "\$200", rationale: "This subtracts only \$40 from the original price.", isCorrect: false } ] }
                                ]
                            },
                            ...
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 4, type: "applied", question: "Jordan earns \$15 per hour and receives a \$45 bonus for completing a project. How much does Jordan earn for working 8 hours including the bonus?", answerOptions: [ { text: "\$120", rationale: "This includes only the hourly pay.", isCorrect: false }, { text: "\$135", rationale: "This adds only part of the bonus.", isCorrect: false }, { text: "\$165", rationale: "Correct. 8 \times 15 = 120 and 120 + 45 = 165.", isCorrect: true }, { text: "\$180", rationale: "This adds the bonus twice.", isCorrect: false } ] },
                                    { questionNumber: 5, type: "applied", question: "A recipe for 12 cookies uses 3 cups of flour. How many cups of flour are needed to make 30 cookies?", answerOptions: [ { text: "5 cups", rationale: "This scales the recipe to 20 cookies.", isCorrect: false }, { text: "6 cups", rationale: "This would make 24 cookies, not 30.", isCorrect: false }, { text: "7.5 cups", rationale: "Correct. 3/12 = x/30 gives x = 7.5 cups.", isCorrect: true }, { text: "9 cups", rationale: "This assumes flour and cookies increase at the same number.", isCorrect: false } ] },
                                    { questionNumber: 6, type: "applied", question: "Maria deposits \$800 into a savings account that earns simple interest at 3% per year. How much interest will she earn in one year?", answerOptions: [ { text: "\$18", rationale: "This equals 2.25% interest.", isCorrect: false }, { text: "\$21", rationale: "This equals 2.625% interest.", isCorrect: false }, { text: "\$24", rationale: "Correct. 800 \times 0.03 = 24.", isCorrect: true }, { text: "\$30", rationale: "This would be 3.75% interest.", isCorrect: false } ] },
                        ...
                        quizzes: [
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 5, type: "knowledge", question: "Simplify 4x^2 - 3x + 2x^2 + 5x.", answerOptions: [ { text: "6x^2 + 2x", rationale: "Correct. Combine 4x^2 + 2x^2 and -3x + 5x separately.", isCorrect: true }, { text: "6x^2 - 8x", rationale: "This subtracts instead of adds the linear terms.", isCorrect: false }, { text: "6x^2 + 8x", rationale: "This adds the coefficients without considering the negative sign.", isCorrect: false }, { text: "8x^2 + 2x", rationale: "This adds 4x^2 and 2x^2 incorrectly.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 7, type: "applied", question: "Evaluate p(x) = x^2 - 2x + 1 when x = -3.", answerOptions: [ { text: "16", rationale: "Correct. Substitute -3 to get 9 + 6 + 1 = 16.", isCorrect: true }, { text: "4", rationale: "This evaluates (-3)^2 - 2(-3) but omits the constant +1.", isCorrect: false }, { text: "-8", rationale: "This treats x^2 as (-3)^2 = -9 incorrectly.", isCorrect: false }, { text: "-16", rationale: "This changes the signs of all terms after substitution.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 9, type: "knowledge", question: "Simplify (2x^2)(-3x^3).", answerOptions: [ { text: "-6x^5", rationale: "Correct. Multiply the coefficients and add the exponents of x.", isCorrect: true }, { text: "-6x^6", rationale: "This adds the exponents incorrectly: 2 + 3 \neq 6.", isCorrect: false }, { text: "-1x^5", rationale: "This multiplies the coefficients incorrectly.", isCorrect: false }, { text: "6x^5", rationale: "This ignores the negative sign from -3x^3.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 12, type: "knowledge", question: "Combine like terms: \frac{1}{2}x + \frac{3}{4}x.", answerOptions: [ { text: "\frac{5}{4}x", rationale: "Correct. Convert \frac{1}{2} to \frac{2}{4} and add to \frac{3}{4}.", isCorrect: true }, { text: "\frac{3}{8}x", rationale: "This adds the denominators instead of the numerators.", isCorrect: false }, { text: "\frac{1}{4}x", rationale: "This subtracts the fractions rather than adding them.", isCorrect: false }, { text: "\frac{7}{4}x", rationale: "This adds an extra \frac{1}{2}x.", isCorrect: false } ] }
                                ]
                            },
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questionSourceTopicId: "math_alg_expressions",
                                questions: [
                                    { questionNumber: 1, type: "knowledge", question: "Solve 3x + 5 = 20.", answerOptions: [ { text: "x = 5", rationale: "Correct. Subtract 5 and divide by 3 to find x.", isCorrect: true }, { text: "x = 15", rationale: "This forgets to divide by 3 after subtracting 5.", isCorrect: false }, { text: "x = \frac{15}{3}", rationale: "This restates 15 without simplifying and ignores subtraction.", isCorrect: false }, { text: "x = \frac{5}{3}", rationale: "This divides 5 by 3 instead of 15 by 3.", isCorrect: false } ] },
                                    { questionNumber: 2, type: "applied", question: "Solve 2(x - 4) = 18.", answerOptions: [ { text: "x = 13", rationale: "Correct. Divide by 2 to get x - 4 = 9 and then add 4.", isCorrect: true }, { text: "x = 7", rationale: "This subtracts instead of adds after dividing.", isCorrect: false }, { text: "x = 11", rationale: "This adds 2 instead of 4 after dividing.", isCorrect: false }, { text: "x = -5", rationale: "This mismanages both the division and addition steps.", isCorrect: false } ] },
                                    { questionNumber: 3, type: "knowledge", question: "Solve \frac{1}{2}x - 4 = 2.", answerOptions: [ { text: "x = 12", rationale: "Correct. Add 4 to get \frac{1}{2}x = 6 and multiply by 2.", isCorrect: true }, { text: "x = 4", rationale: "This stops after adding 4.", isCorrect: false }, { text: "x = -12", rationale: "This adds 4 incorrectly and multiplies by -2.", isCorrect: false }, { text: "x = 3", rationale: "This divides by 2 instead of multiplying after isolating.", isCorrect: false } ] },
                                    { questionNumber: 4, type: "knowledge", question: "Solve 5 - 2x = 13.", answerOptions: [ { text: "x = -4", rationale: "Correct. Subtract 5 to get -2x = 8 and divide by -2.", isCorrect: true }, { text: "x = 4", rationale: "This ignores the negative coefficient on x.", isCorrect: false }, { text: "x = -9", rationale: "This subtracts 5 incorrectly to get -2x = -8.", isCorrect: false }, { text: "x = 9", rationale: "This divides 8 by 2 without addressing the sign.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 6, type: "applied", question: "Solve the inequality -3(x + 2) \leq 12.", answerOptions: [ { text: "x \geq -6", rationale: "Correct. Divide by -3 and reverse the inequality sign.", isCorrect: true }, { text: "x \leq -6", rationale: "This forgets to reverse the inequality when dividing by a negative.", isCorrect: false }, { text: "x \geq 6", rationale: "This adds instead of subtracts when isolating x.", isCorrect: false }, { text: "x \leq 6", rationale: "This mishandles both the sign and the direction of the inequality.", isCorrect: false } ] },
                                    { questionNumber: 7, type: "knowledge", question: "Solve \frac{2}{3}x + 1 = 7.", answerOptions: [ { text: "x = 9", rationale: "Correct. Subtract 1 to get \frac{2}{3}x = 6 and multiply by \frac{3}{2}.", isCorrect: true }, { text: "x = 8", rationale: "This divides 6 by 2 but forgets to multiply by 3.", isCorrect: false }, { text: "x = 3", rationale: "This multiplies 6 by \frac{1}{2} instead of \frac{3}{2}.", isCorrect: false }, { text: "x = -9", rationale: "This subtracts 1 incorrectly and mishandles the fraction.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 9, type: "knowledge", question: "Solve 3x + 4 = 2x - 6.", answerOptions: [ { text: "x = -10", rationale: "Correct. Subtract 2x and 4 to isolate x.", isCorrect: true }, { text: "x = 10", rationale: "This drops the negative sign when moving terms.", isCorrect: false }, { text: "x = -2", rationale: "This subtracts 4 on the wrong side.", isCorrect: false }, { text: "x = 2", rationale: "This divides -6 by 3 without collecting like terms.", isCorrect: false } ] },
                                    { questionNumber: 10, type: "knowledge", question: "Solve the inequality \frac{x}{5} \geq -2.", answerOptions: [ { text: "x \geq -10", rationale: "Correct. Multiply both sides by 5, a positive number.", isCorrect: true }, { text: "x \leq -10", rationale: "The inequality should not reverse when multiplying by a positive number.", isCorrect: false }, { text: "x \geq 10", rationale: "This ignores the negative sign on the right-hand side.", isCorrect: false }, { text: "x \leq 10", rationale: "This reverses the inequality and changes the sign incorrectly.", isCorrect: false } ] },
                                    { questionNumber: 11, type: "applied", question: "Solve 4(x - 1) = 2x + 6.", answerOptions: [ { text: "x = 5", rationale: "Correct. Distribute to get 4x - 4 and then isolate x.", isCorrect: true }, { text: "x = 3", rationale: "This subtracts 4 from 6 incorrectly.", isCorrect: false }, { text: "x = -5", rationale: "This changes the sign when moving terms across the equation.", isCorrect: false }, { text: "x = 10", rationale: "This divides 10 by 1 instead of 2 after simplifying.", isCorrect: false } ] },
                                    { questionNumber: 12, type: "applied", question: "Five more than twice a number is 23. What is the number?", answerOptions: [ { text: "x = 9", rationale: "Correct. Solve 2x + 5 = 23 to get 2x = 18 and x = 9.", isCorrect: true }, { text: "x = 14", rationale: "This adds 5 to 23 instead of subtracting.", isCorrect: false }, { text: "x = 18", rationale: "This equates twice the number directly to 23 without subtracting 5.", isCorrect: false }, { text: "x = \frac{9}{2}", rationale: "This divides 23 by 2 without first removing the added 5.", isCorrect: false } ] }
                                ]
                            },
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questionSourceTopicId: "math_alg_expressions",
                                questions: [
                                    { questionNumber: 1, type: "knowledge", question: "Solve x^2 - 9 = 0.", answerOptions: [ { text: "x = 3 or x = -3", rationale: "Correct. Take the square root of both sides after factoring as (x - 3)(x + 3) = 0.", isCorrect: true }, { text: "x = 9", rationale: "This squares instead of square roots the constant.", isCorrect: false }, { text: "x = 0", rationale: "This is only a solution when the constant term is 0.", isCorrect: false }, { text: "x = \pm \sqrt{9}", rationale: "This repeats the expression without simplifying to numerical values.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 4, type: "applied", question: "Use the quadratic formula to solve 2x^2 - 3x - 2 = 0.", answerOptions: [ { text: "x = 2 or x = -\frac{1}{2}", rationale: "Correct. Substitute a = 2, b = -3, and c = -2 into the formula.", isCorrect: true }, { text: "x = -2 or x = \frac{1}{2}", rationale: "This switches the signs of both solutions.", isCorrect: false }, { text: "x = 3 or x = -\frac{3}{4}", rationale: "This divides by 4 incorrectly inside the formula.", isCorrect: false }, { text: "x = \frac{3 \pm \sqrt{5}}{2}", rationale: "This omits dividing the discriminant by 2a = 4.", isCorrect: false } ] },
                            ...
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questionSourceTopicId: "math_alg_expressions",
                                questions: [
                                    { questionNumber: 1, type: "knowledge", question: "If f(x) = 3x - 4, what is f(5)?", answerOptions: [ { text: "11", rationale: "Correct. Substitute x = 5 to get 15 - 4.", isCorrect: true }, { text: "19", rationale: "This adds instead of subtracts the constant.", isCorrect: false }, { text: "-11", rationale: "This changes the sign of the output unnecessarily.", isCorrect: false }, { text: "1", rationale: "This subtracts 4 from 5 before multiplying by 3.", isCorrect: false } ] },
                                    { questionNumber: 2, type: "applied", question: "If g(t) = 2t^2 - 1, what is g(-2)?", answerOptions: [ { text: "7", rationale: "Correct. 2(4) - 1 = 7.", isCorrect: true }, { text: "-7", rationale: "This forgets that squaring -2 gives a positive 4.", isCorrect: false }, { text: "-3", rationale: "This substitutes -2 without squaring.", isCorrect: false }, { text: "3", rationale: "This halves the correct answer.", isCorrect: false } ] },
                                    { questionNumber: 3, type: "knowledge", question: "What is the slope of the function y = -\frac{1}{2}x + 6?", answerOptions: [ { text: "-\frac{1}{2}", rationale: "Correct. The coefficient of x in slope-intercept form gives the slope.", isCorrect: true }, { text: "\frac{1}{2}", rationale: "This ignores the negative sign.", isCorrect: false }, { text: "6", rationale: "This is the y-intercept, not the slope.", isCorrect: false }, { text: "-6", rationale: "This multiplies the slope and intercept.", isCorrect: false } ] },
                                    { questionNumber: 4, type: "knowledge", question: "What is the domain of f(x) = \sqrt{x - 3}?", answerOptions: [ { text: "x \geq 3", rationale: "Correct. The expression under the square root must be nonnegative.", isCorrect: true }, { text: "x > 0", rationale: "This ignores the -3 inside the radical.", isCorrect: false }, { text: "All real numbers", rationale: "Square roots of negative numbers are not real.", isCorrect: false }, { text: "x \leq 3", rationale: "This reverses the inequality needed to keep the radicand nonnegative.", isCorrect: false } ] },
                                    { questionNumber: 5, type: "knowledge", question: "What is the range of y = x^2 + 2?", answerOptions: [ { text: "y \geq 2", rationale: "Correct. The parabola opens upward and has a minimum of 2.", isCorrect: true }, { text: "y > 0", rationale: "This ignores the vertical shift of +2.", isCorrect: false }, { text: "All real numbers", rationale: "Quadratic functions with positive leading coefficient are bounded below.", isCorrect: false }, { text: "y \leq 2", rationale: "This would describe a downward-opening parabola.", isCorrect: false } ] },
                                    { questionNumber: 6, type: "applied", question: "For f(x) = 2x + 3, what value of x makes f(x) = 11?", answerOptions: [ { text: "x = 4", rationale: "Correct. Solve 2x + 3 = 11 to find x = 4.", isCorrect: true }, { text: "x = 8", rationale: "This forgets to subtract 3 before dividing by 2.", isCorrect: false }, { text: "x = -4", rationale: "This changes the sign when isolating x.", isCorrect: false }, { text: "x = 14", rationale: "This sets x equal to the function output.", isCorrect: false } ] },
                ...
                topics: [
                    {
                        ...
                        quizzes: [
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questions: [
                                    { questionNumber: 1, type: "knowledge", question: "What is the perimeter of a rectangle with length 8 units and width 5 units?", answerOptions: [ { text: "26 units", rationale: "Correct. 2(8 + 5) = 26.", isCorrect: true }, { text: "40 units", rationale: "This multiplies the length and width instead of adding.", isCorrect: false }, { text: "13 units", rationale: "This adds the length and width only once.", isCorrect: false }, { text: "30 units", rationale: "This adds an extra side length.", isCorrect: false } ] },
                                    { questionNumber: 2, type: "knowledge", question: "Find the area of a triangle with base 12 units and height 5 units.", answerOptions: [ { text: "30 square units", rationale: "Correct. Use \tfrac{1}{2}bh = \tfrac{1}{2}(12)(5).", isCorrect: true }, { text: "60 square units", rationale: "This omits the \tfrac{1}{2} factor.", isCorrect: false }, { text: "17 square units", rationale: "This adds the base and height instead of multiplying.", isCorrect: false }, { text: "24 square units", rationale: "This multiplies 12 by 2 rather than 5.", isCorrect: false } ] },
                                    { questionNumber: 3, type: "knowledge", question: "What is the area of a circle with radius 4 units?", answerOptions: [ { text: "16\pi square units", rationale: "Correct. Use A = \pi r^2 = \pi(4^2) = 16\pi.", isCorrect: true }, { text: "8\pi square units", rationale: "This uses the diameter instead of the radius.", isCorrect: false }, { text: "32\pi square units", rationale: "This doubles the correct area.", isCorrect: false }, { text: "64\pi square units", rationale: "This squares the radius and multiplies by 4 again.", isCorrect: false } ] },
                                    { questionNumber: 4, type: "knowledge", question: "A rectangular prism measures 3 cm by 4 cm by 5 cm. What is its volume?", answerOptions: [ { text: "60 cubic centimeters", rationale: "Correct. Multiply the dimensions: 3 \times 4 \times 5 = 60.", isCorrect: true }, { text: "12 cubic centimeters", rationale: "This multiplies only two of the dimensions.", isCorrect: false }, { text: "45 cubic centimeters", rationale: "This omits one dimension when multiplying.", isCorrect: false }, { text: "64 cubic centimeters", rationale: "This treats the prism as a cube with edge 4.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 6, type: "applied", question: "A trapezoid has bases of 10 meters and 6 meters with a height of 4 meters. What is its area?", answerOptions: [ { text: "32 square meters", rationale: "Correct. \tfrac{1}{2}(10 + 6)(4) = 32.", isCorrect: true }, { text: "64 square meters", rationale: "This omits the \tfrac{1}{2} factor.", isCorrect: false }, { text: "16 square meters", rationale: "This averages the bases but forgets to multiply by height.", isCorrect: false }, { text: "20 square meters", rationale: "This uses only one base times the height.", isCorrect: false } ] },
                                    { questionNumber: 7, type: "knowledge", question: "Find the circumference of a circle with radius 7 inches.", answerOptions: [ { text: "14\pi inches", rationale: "Correct. Use C = 2\pi r = 14\pi.", isCorrect: true }, { text: "7\pi inches", rationale: "This omits the factor of 2.", isCorrect: false }, { text: "49\pi inches", rationale: "This squares the radius incorrectly.", isCorrect: false }, { text: "28\pi inches", rationale: "This doubles the correct circumference.", isCorrect: false } ] },
                                    { questionNumber: 8, type: "applied", question: "What is the volume of a cylinder with radius 3 feet and height 10 feet?", answerOptions: [ { text: "90\pi cubic feet", rationale: "Correct. V = \pi r^2 h = \pi(9)(10).", isCorrect: true }, { text: "30\pi cubic feet", rationale: "This forgets to square the radius.", isCorrect: false }, { text: "60\pi cubic feet", rationale: "This multiplies only one radius by the height.", isCorrect: false }, { text: "180\pi cubic feet", rationale: "This doubles the correct product.", isCorrect: false } ] },
                                    { questionNumber: 9, type: "applied", question: "A square has an area of 81 square centimeters. What is the length of one side?", answerOptions: [ { text: "9 centimeters", rationale: "Correct. Take the square root of the area: \sqrt{81} = 9.", isCorrect: true }, { text: "18 centimeters", rationale: "This doubles the correct side length.", isCorrect: false }, { text: "81 centimeters", rationale: "This uses the area itself as the side length.", isCorrect: false }, { text: "27 centimeters", rationale: "This cubes the side length unnecessarily.", isCorrect: false } ] },
                                    { questionNumber: 10, type: "applied", question: "A rectangular garden is 20 feet long and 15 feet wide. What is its area?", answerOptions: [ { text: "300 square feet", rationale: "Correct. Multiply length by width.", isCorrect: true }, { text: "70 square feet", rationale: "This adds the dimensions rather than multiplying.", isCorrect: false }, { text: "140 square feet", rationale: "This doubles the perimeter instead of finding area.", isCorrect: false }, { text: "225 square feet", rationale: "This multiplies 15 by itself.", isCorrect: false } ] },
                                    { questionNumber: 11, type: "knowledge", question: "The perimeter of a rectangle is 54 meters. If the length is 20 meters, what is the width?", answerOptions: [ { text: "7 meters", rationale: "Correct. 2(20 + w) = 54 leads to w = 7.", isCorrect: true }, { text: "14 meters", rationale: "This divides the perimeter by 4 without subtracting the length first.", isCorrect: false }, { text: "34 meters", rationale: "This subtracts the length just once instead of twice.", isCorrect: false }, { text: "17 meters", rationale: "This subtracts 20 from 54 without accounting for both lengths.", isCorrect: false } ] },
                                    { questionNumber: 12, type: "applied", question: "A right triangular prism has a base area of 24 square inches and a height of 9 inches. What is its volume?", answerOptions: [ { text: "216 cubic inches", rationale: "Correct. Multiply the base area by the height: 24 \times 9.", isCorrect: true }, { text: "48 cubic inches", rationale: "This doubles the base area but omits the prism height.", isCorrect: false }, { text: "33 cubic inches", rationale: "This averages the base area and height incorrectly.", isCorrect: false }, { text: "432 cubic inches", rationale: "This multiplies by the height twice.", isCorrect: false } ] }
                                ]
                            },
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questionSourceTopicId: "math_geom_basics",
                                questions: [
                                    { questionNumber: 1, type: "knowledge", question: "Which statement is always true about a parallelogram?", answerOptions: [ { text: "Opposite sides are parallel.", rationale: "Correct. This property defines a parallelogram.", isCorrect: true }, { text: "All angles are right angles.", rationale: "Only rectangles and squares guarantee right angles.", isCorrect: false }, { text: "All sides are congruent.", rationale: "This describes a rhombus, not every parallelogram.", isCorrect: false }, { text: "Diagonals are congruent.", rationale: "This is true for rectangles, not all parallelograms.", isCorrect: false } ] },
                                    { questionNumber: 2, type: "knowledge", question: "What is the sum of the interior angles of a pentagon?", answerOptions: [ { text: "540^\circ", rationale: "Correct. (n - 2) \times 180 = 3 \times 180.", isCorrect: true }, { text: "360^\circ", rationale: "This is the sum for a quadrilateral.", isCorrect: false }, { text: "720^\circ", rationale: "This is the sum for a hexagon.", isCorrect: false }, { text: "900^\circ", rationale: "This overestimates by using n \times 180.", isCorrect: false } ] },
                                    { questionNumber: 3, type: "knowledge", question: "A triangle has side lengths 7, 7, and 5. What type of triangle is it?", answerOptions: [ { text: "Isosceles", rationale: "Correct. Two sides are congruent.", isCorrect: true }, { text: "Equilateral", rationale: "Equilateral triangles have three equal sides.", isCorrect: false }, { text: "Scalene", rationale: "Scalene triangles have no equal sides.", isCorrect: false }, { text: "Right", rationale: "The side lengths do not satisfy the Pythagorean theorem.", isCorrect: false } ] },
                                    { questionNumber: 4, type: "knowledge", question: "What is the measure of each interior angle in a regular octagon?", answerOptions: [ { text: "135^\circ", rationale: "Correct. Use \frac{(n - 2) \times 180}{n} = \frac{6 \times 180}{8}.", isCorrect: true }, { text: "120^\circ", rationale: "This is the interior angle of a regular hexagon.", isCorrect: false }, { text: "140^\circ", rationale: "This results from miscalculating the numerator.", isCorrect: false }, { text: "160^\circ", rationale: "This assumes an incorrect angle sum.", isCorrect: false } ] },
                                    { questionNumber: 5, type: "knowledge", question: "Which statement best defines a trapezoid (in the inclusive definition)?", answerOptions: [ { text: "A quadrilateral with at least one pair of parallel sides.", rationale: "Correct. Inclusive definitions allow parallelograms to count as trapezoids.", isCorrect: true }, { text: "A quadrilateral with both pairs of opposite sides parallel.", rationale: "This defines a parallelogram.", isCorrect: false }, { text: "A quadrilateral with all sides congruent.", rationale: "This describes a rhombus.", isCorrect: false }, { text: "A quadrilateral with exactly two right angles.", rationale: "Right angles are not required.", isCorrect: false } ] },
                                    { questionNumber: 6, type: "knowledge", question: "What is the measure of each exterior angle of a regular decagon?", answerOptions: [ { text: "36^\circ", rationale: "Correct. Exterior angles sum to 360^\circ, so 360 \div 10 = 36.", isCorrect: true }, { text: "18^\circ", rationale: "This divides 180 by the number of sides instead of 360.", isCorrect: false }, { text: "54^\circ", rationale: "This corresponds to a regular heptagon.", isCorrect: false }, { text: "144^\circ", rationale: "This is an interior angle measurement.", isCorrect: false } ] },
                                    { questionNumber: 7, type: "applied", question: "A triangle has angles measuring 90^\circ, 45^\circ, and 45^\circ. How is it classified?", answerOptions: [ { text: "Right isosceles triangle", rationale: "Correct. It has a right angle and two equal angles.", isCorrect: true }, { text: "Acute scalene triangle", rationale: "The triangle contains a right angle, not all acute angles.", isCorrect: false }, { text: "Obtuse isosceles triangle", rationale: "There is no obtuse angle.", isCorrect: false }, { text: "Equilateral triangle", rationale: "Equilateral triangles have three 60^\circ angles.", isCorrect: false } ] },
                                    { questionNumber: 8, type: "knowledge", question: "How many diagonals can be drawn in a hexagon?", answerOptions: [ { text: "9", rationale: "Correct. Use \frac{n(n - 3)}{2} = \frac{6 \times 3}{2}.", isCorrect: true }, { text: "6", rationale: "This counts only the sides.", isCorrect: false }, { text: "12", rationale: "This counts each diagonal twice.", isCorrect: false }, { text: "15", rationale: "This applies the formula for an octagon.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 11, type: "applied", question: "Two angles of a triangle measure 35^\circ and 65^\circ. What is the measure of the third angle?", answerOptions: [ { text: "80^\circ", rationale: "Correct. The angles of a triangle sum to 180^\circ.", isCorrect: true }, { text: "90^\circ", rationale: "This assumes the triangle is right without calculation.", isCorrect: false }, { text: "70^\circ", rationale: "This subtracts only one given angle from 180^\circ.", isCorrect: false }, { text: "45^\circ", rationale: "This averages the given angles instead of subtracting their sum.", isCorrect: false } ] },
                                    { questionNumber: 12, type: "knowledge", question: "Which statement is true about a kite?", answerOptions: [ { text: "It has two distinct pairs of adjacent congruent sides.", rationale: "Correct. This property defines a kite.", isCorrect: true }, { text: "All four sides are congruent.", rationale: "That describes a rhombus.", isCorrect: false }, { text: "Opposite sides are parallel.", rationale: "This is a property of parallelograms, not kites.", isCorrect: false }, { text: "Its diagonals are both bisected.", rationale: "Only one diagonal is bisected in a kite.", isCorrect: false } ] }
                                ]
                            },
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 3, type: "knowledge", question: "Do side lengths 7, 24, and 25 form a right triangle?", answerOptions: [ { text: "Yes, because 7^2 + 24^2 = 25^2.", rationale: "Correct. 49 + 576 = 625 equals 25^2.", isCorrect: true }, { text: "No, because 7 + 24 \neq 25.", rationale: "Triangle classification depends on squared side lengths, not sums.", isCorrect: false }, { text: "No, because the sides are not consecutive numbers.", rationale: "Consecutive numbers are not required for right triangles.", isCorrect: false }, { text: "Yes, because all sides are different.", rationale: "Being scalene alone does not guarantee a right triangle.", isCorrect: false } ] },
                                    { questionNumber: 4, type: "applied", question: "A 15-foot ladder reaches the top of a wall 12 feet high. How far is the base of the ladder from the wall?", answerOptions: [ { text: "9 feet", rationale: "Correct. 15^2 - 12^2 = 225 - 144 = 81, so the base is \sqrt{81} = 9 feet away.", isCorrect: true }, { text: "3 feet", rationale: "This subtracts 12 from 15 without squaring.", isCorrect: false }, { text: "18 feet", rationale: "This adds the ladder length and wall height.", isCorrect: false }, { text: "13 feet", rationale: "This misapplies the theorem by averaging the legs.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 8, type: "knowledge", question: "In a 45^\circ-45^\circ-90^\circ triangle with leg length 7, what is the hypotenuse?", answerOptions: [ { text: "7\sqrt{2}", rationale: "Correct. Multiply a leg by \sqrt{2} for the hypotenuse in this special triangle.", isCorrect: true }, { text: "7", rationale: "This would make the triangle equilateral.", isCorrect: false }, { text: "14", rationale: "This doubles the leg length instead of using \sqrt{2}.", isCorrect: false }, { text: "7\sqrt{3}", rationale: "This corresponds to a 30^\circ-60^\circ-90^\circ triangle.", isCorrect: false } ] },
                                    { questionNumber: 9, type: "knowledge", question: "In a 30^\circ-60^\circ-90^\circ triangle, the shorter leg is 4. What is the hypotenuse?", answerOptions: [ { text: "8", rationale: "Correct. The hypotenuse is twice the shorter leg.", isCorrect: true }, { text: "4\sqrt{3}", rationale: "This gives the length of the longer leg.", isCorrect: false }, { text: "6", rationale: "This averages the two legs.", isCorrect: false }, { text: "2", rationale: "This halves the shorter leg instead of doubling it.", isCorrect: false } ] },
                            ...
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 5, type: "applied", question: "If \angle A and \angle B are vertical angles and m\angle A = 120^\circ, what is m\angle B?", answerOptions: [ { text: "120^\circ", rationale: "Correct. Vertical angles are congruent.", isCorrect: true }, { text: "60^\circ", rationale: "This halves the given angle without justification.", isCorrect: false }, { text: "180^\circ", rationale: "This gives the supplementary angle instead.", isCorrect: false }, { text: "30^\circ", rationale: "This divides the angle by four randomly.", isCorrect: false } ] },
                                    { questionNumber: 6, type: "knowledge", question: "What is the slope of the line passing through (1, -2) and (5, 6)?", answerOptions: [ { text: "2", rationale: "Correct. \frac{6 - (-2)}{5 - 1} = \frac{8}{4} = 2.", isCorrect: true }, { text: "-2", rationale: "This reverses the change in y.", isCorrect: false }, { text: "\frac{1}{2}", rationale: "This swaps the numerator and denominator.", isCorrect: false }, { text: "8", rationale: "This divides the change in y by 1.", isCorrect: false } ] },
                                    { questionNumber: 7, type: "knowledge", question: "A line has slope \frac{3}{4}. What is the slope of a line perpendicular to it?", answerOptions: [ { text: "-\frac{4}{3}", rationale: "Correct. Perpendicular slopes are negative reciprocals.", isCorrect: true }, { text: "\frac{4}{3}", rationale: "This gives a parallel slope.", isCorrect: false }, { text: "-\frac{3}{4}", rationale: "This keeps the same slope but changes the sign.", isCorrect: false }, { text: "\frac{3}{4}", rationale: "This repeats the original slope.", isCorrect: false } ] },
                                    { questionNumber: 8, type: "applied", question: "What is the equation of the line with slope -1 passing through (2, 3)?", answerOptions: [ { text: "y = -x + 5", rationale: "Correct. Use point-slope form: y - 3 = -1(x - 2).", isCorrect: true }, { text: "y = -x - 1", rationale: "This assumes the line passes through the origin.", isCorrect: false }, { text: "y = x - 5", rationale: "This uses the opposite slope.", isCorrect: false }, { text: "y = -x + 1", rationale: "This substitutes x for the y-intercept.", isCorrect: false } ] },
                                    { questionNumber: 9, type: "applied", question: "Are the lines y = 2x + 1 and y = -\tfrac{1}{2}x + 4 perpendicular?", answerOptions: [ { text: "Yes, because the product of the slopes is -1.", rationale: "Correct. 2 \times -\tfrac{1}{2} = -1.", isCorrect: true }, { text: "No, because the lines have different y-intercepts.", rationale: "Different intercepts do not prevent perpendicularity.", isCorrect: false }, { text: "Yes, because both lines have positive slopes.", rationale: "One slope is negative.", isCorrect: false }, { text: "No, because the slopes are reciprocals but not negatives.", rationale: "The slopes are negative reciprocals, satisfying the perpendicular condition.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 11, type: "knowledge", question: "In a triangle, the exterior angle is equal to the sum of the two remote interior angles. If the remote interior angles are 40^\circ and 55^\circ, what is the measure of the exterior angle?", answerOptions: [ { text: "95^\circ", rationale: "Correct. Add the measures of the two remote interior angles.", isCorrect: true }, { text: "85^\circ", rationale: "This subtracts the smaller angle from the larger.", isCorrect: false }, { text: "125^\circ", rationale: "This adds the remote angles to 180^\circ.", isCorrect: false }, { text: "15^\circ", rationale: "This finds the difference rather than the sum.", isCorrect: false } ] },
                                    { questionNumber: 12, type: "knowledge", question: "An angle measuring 135^\circ is classified as which type of angle?", answerOptions: [ { text: "Obtuse", rationale: "Correct. Obtuse angles measure between 90^\circ and 180^\circ.", isCorrect: true }, { text: "Acute", rationale: "Acute angles are less than 90^\circ.", isCorrect: false }, { text: "Right", rationale: "Right angles measure exactly 90^\circ.", isCorrect: false }, { text: "Straight", rationale: "Straight angles measure 180^\circ.", isCorrect: false } ] }
                                ]
                            }
                        ]
                    }
