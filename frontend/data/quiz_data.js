                        ...
                        quizzes: [
                            {
                                ...
                                label: "Quiz A",
                                description: "Master core operations with whole numbers, decimals, and fractions.",
                                questionSourceTopicId: "math_quant_basics",
                                questions: [
                                    { questionNumber: 1, type: "knowledge", question: "Compute 63 + 48.", answerOptions: [ { text: "109", rationale: "This subtracts 2 from the correct total.", isCorrect: false }, { text: "111", rationale: "Correct. 63 + 48 = 111.", isCorrect: true }, { text: "112", rationale: "This adds 49 instead of 48.", isCorrect: false }, { text: "113", rationale: "This adds 50 instead of 48.", isCorrect: false } ] },
                                    { questionNumber: 2, type: "knowledge", question: "Evaluate 215 - 87.", answerOptions: [ { text: "118", rationale: "This subtracts 97 instead of 87.", isCorrect: false }, { text: "126", rationale: "This subtracts 89 instead of 87.", isCorrect: false }, { text: "128", rationale: "Correct. 215 - 87 = 128.", isCorrect: true }, { text: "132", rationale: "This subtracts only 83.", isCorrect: false } ] },
                                    { questionNumber: 3, type: "applied", question: "Find 4.2 \\times 1.5.", answerOptions: [ { text: "5.7", rationale: "This multiplies 3.8 by 1.5 instead.", isCorrect: false }, { text: "6.0", rationale: "This rounds 1.5 down to 1.4 before multiplying.", isCorrect: false }, { text: "6.3", rationale: "Correct. 4.2 \\times 1.5 = 6.3.", isCorrect: true }, { text: "6.7", rationale: "This adds 4.2 and 1.5 instead of multiplying.", isCorrect: false } ] },
                                    { questionNumber: 4, type: "knowledge", question: "What is 18.75 \\div 0.25?", answerOptions: [ { text: "7.5", rationale: "This divides by 2.5 instead of 0.25.", isCorrect: false }, { text: "37.5", rationale: "This multiplies by 2 instead of dividing by 0.25.", isCorrect: false }, { text: "75", rationale: "Correct. Dividing by 0.25 is the same as multiplying by 4.", isCorrect: true }, { text: "94", rationale: "This adds 18.75 and 75.", isCorrect: false } ] },
                                    { questionNumber: 5, type: "knowledge", question: "Add 2/5 + 3/10.", answerOptions: [ { text: "1/2", rationale: "This treats 3/10 as 1/5 before adding.", isCorrect: false }, { text: "7/10", rationale: "Correct. Convert 2/5 to 4/10, then add 4/10 + 3/10.", isCorrect: true }, { text: "9/10", rationale: "This adds 2/5 to 1/2 instead of 3/10.", isCorrect: false }, { text: "1 1/5", rationale: "This adds the denominators directly.", isCorrect: false } ] }
                                ]
                            },

                            {
                                ...
                                label: "Quiz B",
                                description: "Practice ratios, proportions, and percentage reasoning.",
                                questionSourceTopicId: "math_quant_basics",
                                questions: [
                                    { questionNumber: 1, type: "knowledge", question: "Simplify the ratio 42:56 to lowest terms.", answerOptions: [ { text: "2:3", rationale: "Dividing by 21 instead of the greatest common factor leaves a fraction.", isCorrect: false }, { text: "3:4", rationale: "Correct. Divide both numbers by 14.", isCorrect: true }, { text: "4:7", rationale: "This reverses the ratio after simplifying.", isCorrect: false }, { text: "6:7", rationale: "This divides only the first term by 7.", isCorrect: false } ] },
                                    { questionNumber: 2, type: "applied", question: "Solve 5/8 = x/40.", answerOptions: [ { text: "20", rationale: "This multiplies 5 by 4 instead of 5 by 5.", isCorrect: false }, { text: "25", rationale: "Correct. Multiply both sides by 40 to get x = 25.", isCorrect: true }, { text: "32", rationale: "This multiplies 8 by 4 instead of cross-multiplying.", isCorrect: false }, { text: "35", rationale: "This treats 5/8 as 5/10.", isCorrect: false } ] },
                                    { questionNumber: 3, type: "applied", question: "A store marks up \\$240 by 12%. What is the new price?", answerOptions: [ { text: "\$254.40", rationale: "This uses 6% instead of 12%.", isCorrect: false }, { text: "\$268.80", rationale: "Correct. The markup is 0.12 \\times 240 = 28.80, so add it to 240.", isCorrect: true }, { text: "\$270.00", rationale: "This rounds 12% of 240 to 30.", isCorrect: false }, { text: "\$300.00", rationale: "This applies a 25% increase instead of 12%.", isCorrect: false } ] },
                                    { questionNumber: 4, type: "knowledge", question: "What percent is 18 out of 24?", answerOptions: [ { text: "60%", rationale: "This divides 18 by 30.", isCorrect: false }, { text: "66 2/3%", rationale: "This assumes the denominator is 27.", isCorrect: false }, { text: "72%", rationale: "This multiplies by 4 instead of 100 when converting.", isCorrect: false }, { text: "75%", rationale: "Correct. 18/24 = 0.75 = 75%.", isCorrect: true } ] },
                                    { questionNumber: 5, type: "knowledge", question: "Convert 0.085 to a percent.", answerOptions: [ { text: "0.85%", rationale: "This multiplies by 10 instead of 100.", isCorrect: false }, { text: "0.0085%", rationale: "This divides by 100 instead of multiplying.", isCorrect: false }, { text: "8.5%", rationale: "Correct. Move the decimal two places to the right.", isCorrect: true }, { text: "85%", rationale: "This multiplies by 1000.", isCorrect: false } ] }
                                ]
                            },

                            {
                                ...
                                label: "Quiz C",
                                description: "Apply quantitative reasoning to multi-step problems.",
                                questionSourceTopicId: "math_quant_basics",
                                questions: [
                                    { questionNumber: 1, type: "applied", question: "A rectangular room is 12 feet by 15 feet. What is its area in square feet?", answerOptions: [ { text: "24 square feet", rationale: "This multiplies 12 by 2 instead of 15.", isCorrect: false }, { text: "27 square feet", rationale: "This adds the side lengths before multiplying.", isCorrect: false }, { text: "180 square feet", rationale: "Correct. Area equals length \\times width = 12 \\times 15.", isCorrect: true }, { text: "360 square feet", rationale: "This doubles the correct product.", isCorrect: false } ] },
                                    { questionNumber: 2, type: "applied", question: "Evaluate 3(2x + 5) for x = 4.", answerOptions: [ { text: "27", rationale: "This multiplies 3 by (2 \\times 4) only.", isCorrect: false }, { text: "33", rationale: "This adds 3 after multiplying 2x + 5.", isCorrect: false }, { text: "39", rationale: "Correct. Substitute x = 4 to get 3(8 + 5) = 3 \\times 13 = 39.", isCorrect: true }, { text: "78", rationale: "This multiplies by 6 instead of 3 after substitution.", isCorrect: false } ] },
                                    { questionNumber: 3, type: "knowledge", question: "Solve 2x + 7 = 31.", answerOptions: [ { text: "x = 9", rationale: "This divides 31 by 3 instead of subtracting 7 first.", isCorrect: false }, { text: "x = 12", rationale: "Correct. Subtract 7 to get 2x = 24, then divide by 2.", isCorrect: true }, { text: "x = 15", rationale: "This adds 7 to 31 before dividing.", isCorrect: false }, { text: "x = 38", rationale: "This multiplies 31 by 2 instead of isolating x.", isCorrect: false } ] },
                                    { questionNumber: 4, type: "knowledge", question: "What is \\sqrt{196}?", answerOptions: [ { text: "10", rationale: "10^2 = 100, not 196.", isCorrect: false }, { text: "12", rationale: "12^2 = 144.", isCorrect: false }, { text: "14", rationale: "Correct. 14^2 = 196.", isCorrect: true }, { text: "28", rationale: "This doubles the correct square root.", isCorrect: false } ] },
                                    { questionNumber: 5, type: "applied", question: "A savings account earns simple interest on \$900 at 4% annually. How much interest is earned in one year?", answerOptions: [ { text: "\$18", rationale: "This uses a 2% rate.", isCorrect: false }, { text: "\$27", rationale: "This applies a 3% rate.", isCorrect: false }, { text: "\$36", rationale: "Correct. Interest = principal \\times rate \\times time = 900 \\times 0.04 \\times 1.", isCorrect: true }, { text: "\$45", rationale: "This applies a 5% rate.", isCorrect: false } ] }
                                ]
                            }
