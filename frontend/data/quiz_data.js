                        ...
                        quizzes: [
                            ...
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 2, type: "application", question: "Solve $2(x - 4) = 18$.", answerOptions: [ { text: "$x = 13$", rationale: "Correct. Divide by $2$ to get $x - 4 = 9$ and then add $4$.", isCorrect: true }, { text: "$x = 7$", rationale: "This subtracts instead of adds after dividing.", isCorrect: false }, { text: "$x = 11$", rationale: "This adds $2$ instead of $4$ after dividing.", isCorrect: false }, { text: "$x = -5$", rationale: "This mismanages both the division and addition steps.", isCorrect: false } ] },
                            ...
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 4, type: "application", question: "Use the quadratic formula to solve $2x^2 - 3x - 2 = 0$.", answerOptions: [ { text: "$x = 2$ or $x = -\frac{1}{2}$", rationale: "Correct. Substitute $a = 2$, $b = -3$, and $c = -2$ into the formula.", isCorrect: true }, { text: "$x = -2$ or $x = \frac{1}{2}$", rationale: "This switches the signs of both solutions.", isCorrect: false }, { text: "$x = 3$ or $x = -\frac{3}{4}$", rationale: "This divides by $4$ incorrectly inside the formula.", isCorrect: false }, { text: "$x = \frac{3 \pm \sqrt{5}}{2}$", rationale: "This omits dividing the discriminant by $2a = 4$.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 10, type: "application", question: "Solve $-2(x + 1)^2 + 8 = 0$.", answerOptions: [ { text: "$x = 1$ or $x = -3$", rationale: "Correct. Move $8$, divide by $-2$, and take square roots.", isCorrect: true }, { text: "$x = -1$ or $x = 3$", rationale: "This reverses the shifts inside the parentheses.", isCorrect: false }, { text: "$x = 2$", rationale: "This assumes a single root without considering symmetry.", isCorrect: false }, { text: "$x = -4$", rationale: "This substitutes $x$ for $(x + 1)$ directly.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 12, type: "application", question: "What is the maximum value of $y = -x^2 + 4x + 1$?", answerOptions: [ { text: "$5$", rationale: "Correct. The vertex at $x = 2$ gives $y = -4 + 8 + 1 = 5$.", isCorrect: true }, { text: "$-5$", rationale: "This negates the correct value.", isCorrect: false }, { text: "$1$", rationale: "This is the constant term, not the vertex value.", isCorrect: false }, { text: "$4$", rationale: "This evaluates the function at $x = 1$ instead of the vertex.", isCorrect: false } ] }
                                ]
                            },
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 11, type: "application", question: "What is the average rate of change of $f(x) = x^2$ from $x = 1$ to $x = 4$?", answerOptions: [ { text: "$5$", rationale: "Correct. $\frac{f(4) - f(1)}{4 - 1} = \frac{16 - 1}{3} = 5$.", isCorrect: true }, { text: "$3$", rationale: "This divides by $4$ instead of $3$.", isCorrect: false }, { text: "$7$", rationale: "This subtracts $1$ from $16$ incorrectly.", isCorrect: false }, { text: "$15$", rationale: "This omits dividing by the change in $x$.", isCorrect: false } ] },
                                    { questionNumber: 12, type: "application", question: "A function maps input $x$ to output $2x - 1$. If the output is $9$, what was the input?", answerOptions: [ { text: "$x = 5$", rationale: "Correct. Solve $2x - 1 = 9$ to get $x = 5$.", isCorrect: true }, { text: "$x = 4$", rationale: "This subtracts $1$ from $9$ but forgets to divide by $2$.", isCorrect: false }, { text: "$x = 10$", rationale: "This sets the input equal to twice the output.", isCorrect: false }, { text: "$x = -5$", rationale: "This changes the sign while solving.", isCorrect: false } ] }
                                ]
                            }
                        ]
                    }
                        ...
                        quizzes: [
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 8, type: "application", question: "What is the volume of a cylinder with radius $3$ feet and height $10$ feet?", answerOptions: [ { text: "$90\pi$ cubic feet", rationale: "Correct. $V = \pi r^2 h = \pi(9)(10)$.", isCorrect: true }, { text: "$30\pi$ cubic feet", rationale: "This forgets to square the radius.", isCorrect: false }, { text: "$60\pi$ cubic feet", rationale: "This multiplies only one radius by the height.", isCorrect: false }, { text: "$180\pi$ cubic feet", rationale: "This doubles the correct product.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 12, type: "application", question: "A right triangular prism has a base area of $24$ square inches and a height of $9$ inches. What is its volume?", answerOptions: [ { text: "$216$ cubic inches", rationale: "Correct. Multiply the base area by the height: $24 \times 9$.", isCorrect: true }, { text: "$48$ cubic inches", rationale: "This doubles the base area but omits the prism height.", isCorrect: false }, { text: "$33$ cubic inches", rationale: "This averages the base area and height incorrectly.", isCorrect: false }, { text: "$432$ cubic inches", rationale: "This multiplies by the height twice.", isCorrect: false } ] }
                                ]
                            },
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 11, type: "application", question: "Two angles of a triangle measure $35^\circ$ and $65^\circ$. What is the measure of the third angle?", answerOptions: [ { text: "$80^\circ$", rationale: "Correct. The angles of a triangle sum to $180^\circ$.", isCorrect: true }, { text: "$90^\circ$", rationale: "This assumes the triangle is right without calculation.", isCorrect: false }, { text: "$70^\circ$", rationale: "This subtracts only one given angle from $180^\circ$.", isCorrect: false }, { text: "$45^\circ$", rationale: "This averages the given angles instead of subtracting their sum.", isCorrect: false } ] },
                            ...
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 4, type: "application", question: "A $15$-foot ladder reaches the top of a wall $12$ feet high. How far is the base of the ladder from the wall?", answerOptions: [ { text: "$9$ feet", rationale: "Correct. $15^2 - 12^2 = 225 - 144 = 81$, so the base is $\sqrt{81} = 9$ feet away.", isCorrect: true }, { text: "$3$ feet", rationale: "This subtracts $12$ from $15$ without squaring.", isCorrect: false }, { text: "$18$ feet", rationale: "This adds the ladder length and wall height.", isCorrect: false }, { text: "$13$ feet", rationale: "This misapplies the theorem by averaging the legs.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 12, type: "application", question: "How far is the point $(-3, 4)$ from the origin?", answerOptions: [ { text: "$5$ units", rationale: "Correct. $(-3)^2 + 4^2 = 9 + 16 = 25$, and $\sqrt{25} = 5$.", isCorrect: true }, { text: "$1$ unit", rationale: "This subtracts the coordinates instead of using distance.", isCorrect: false }, { text: "$7$ units", rationale: "This adds the absolute values of the coordinates.", isCorrect: false }, { text: "$\sqrt{7}$ units", rationale: "This squares only one coordinate.", isCorrect: false } ] }
                                ]
                            },
                            // TODO: UNDER-MINIMUM originally. Added questions to reach 12.
                            {
                                ...
                                questions: [
                                    ...
                                    { questionNumber: 5, type: "application", question: "If $\angle A$ and $\angle B$ are vertical angles and $m\angle A = 120^\circ$, what is $m\angle B$?", answerOptions: [ { text: "$120^\circ$", rationale: "Correct. Vertical angles are congruent.", isCorrect: true }, { text: "$60^\circ$", rationale: "This halves the given angle without justification.", isCorrect: false }, { text: "$180^\circ$", rationale: "This gives the supplementary angle instead.", isCorrect: false }, { text: "$30^\circ$", rationale: "This divides the angle by four randomly.", isCorrect: false } ] },
                                    ...
                                    { questionNumber: 8, type: "application", question: "What is the equation of the line with slope $-1$ passing through $(2, 3)$?", answerOptions: [ { text: "$y = -x + 5$", rationale: "Correct. Use point-slope form: $y - 3 = -1(x - 2)$.", isCorrect: true }, { text: "$y = -x - 1$", rationale: "This assumes the line passes through the origin.", isCorrect: false }, { text: "$y = x - 5$", rationale: "This uses the opposite slope.", isCorrect: false }, { text: "$y = -x + 1$", rationale: "This substitutes $x$ for the $y$-intercept.", isCorrect: false } ] },
