...
export const ELECTORAL_COLLEGE_SCENARIOS = [
  ...
  },
  {
    ...
    choices: [
      {
        id: 'A',
        label: 'Each state gets at least 3 EVs (1 House + 2 Senators).',
        isCorrect: true,
      },
      {
        id: 'B',
        label: 'They are guaranteed 3 EVs by the 23rd Amendment.',
        isCorrect: false,
      },
      {
        id: 'C',
        label: 'EVs are based purely on land area.',
        isCorrect: false,
      },
      {
        id: 'D',
        label: 'Small states are always swing states.',
        isCorrect: false,
      },
    ],
    explanation:
  ...
  },
  {
    ...
    choices: [
      {
        id: 'A',
        label: 'Cand. A won popular and electoral.',
        isCorrect: false,
      },
      { id: 'B', label: 'Cand. B won popular and electoral.', isCorrect: true },
      {
        id: 'C',
        label: 'Cand. A won popular; Cand. B won electoral.',
        isCorrect: false,
      },
  ...
  },
  {
    ...
    choices: [
      {
        id: 'A',
        label: 'A wins PA, MI, and GA → 276 EVs → wins.',
        isCorrect: true,
      },
      {
        id: 'B',
        label: 'A wins PA, MI, GA → 256 EVs → loses.',
        isCorrect: false,
      },
      { id: 'C', label: 'A only wins PA → 245 EVs → loses.', isCorrect: false },
      {
        id: 'D',
        label: 'A wins all three but only reaches 270 exactly.',
        isCorrect: false,
      },
    ],
    explanation:
