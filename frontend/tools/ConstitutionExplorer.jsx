      ...
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        ...
        <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-lg font-bold">Practice Scenarios</h2>
            {selectedScenario && (
              <button
                onClick={resetScenario}
                className="text-sm px-3 py-1 rounded bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600"
              >
                Clear
              </button>
            )}
            ...
            {availableScenarios.map((s) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="font-semibold">{s.prompt}</span>
          ...
          {selectedScenario && (
            <div className="mt-4 p-3 rounded-lg bg-white/80 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700">
              <div className="text-sm mb-2">Select the correct amendment:</div>
