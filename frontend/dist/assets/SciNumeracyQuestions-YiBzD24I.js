const SCI_NUMERACY_QUESTIONS = [
  ...
  },
  {
    ...
    qaProfileKey: "numeracy",
    type: "knowledge",
    passage: "<p>In pea plants, purple flowers (P) are dominant over white flowers (p). Two heterozygous plants (Pp Ã— Pp) are crossed.</p>",
  ...
  },
  {
    ...
    qaProfileKey: "numeracy",
    type: "knowledge",
    passage: "<p>A beaker contains 250 mL of water. 50 mL evaporates. How much is left?</p>",
  ...
  },
  {
    ...
    qaProfileKey: "numeracy",
    type: "knowledge",
    passage: "<p>A student records temperatures: 10Â°C, 12Â°C, 15Â°C, 13Â°C, 10Â°C.</p>",
  ...
  },
  {
    ...
    qaProfileKey: "numeracy",
    type: "knowledge",
    passage: "<p>A car uses 8 liters of fuel to travel 100 km. How many liters for 250 km?</p>",
  ...
  },
  {
    ...
    qaProfileKey: "numeracy",
    type: "knowledge",
    passage: "<p>A sample has masses: 2g, 4g, 6g, 8g, 10g. What is the mean?</p>",
  ...
  },
  {
    ...
    qaProfileKey: "numeracy",
    type: "knowledge",
    passage: "<p>A block is pulled with a force of 10 N for 5 m. How much work is done?</p>",
  ...
  },
  {
    ...
    qaProfileKey: "numeracy",
    type: "knowledge",
    passage: "<p>A solution is made by mixing 100 mL of water and 50 mL of alcohol. What is the total volume?</p>",
...
export {
  SCI_NUMERACY_QUESTIONS
};
//# sourceMappingURL=SciNumeracyQuestions-YiBzD24I.js.map
