const RLA_QUESTIONS = {
                ...
                answerOptions: [
                  {
                    ...
                    rationale: "The article presents makerspaces as lasting investments, not fleeting trends.",
                    isCorrect: false
                  },
                  {
                    text: "Community makerspaces help residents gain affordable access to modern tools and skills that support career growth.",
                    rationale: "Correct. Every paragraph explains how makerspaces expand access, deliver training, and create economic opportunities.",
                    isCorrect: true
                  },
                  {
                    text: "Traditional classrooms are no longer useful for any type of technical training.",
                    rationale: "The author contrasts makerspaces with classrooms but never dismisses classrooms entirely.",
                    isCorrect: false
                  },
                  {
                    text: "Municipal budgets should focus exclusively on transit projects instead of technology hubs.",
                    rationale: "Transit is mentioned only as something planners consider alongside makerspaces, not instead of them.",
                    isCorrect: false
                  }
                ]
              },
                ...
                answerOptions: [
                  {
                    ...
                    rationale: "This shows the collaborative setting but not specifically increased access for residents who could not otherwise use technology.",
                    isCorrect: false
                  },
                  {
                    text: "A 2023 survey reported that 62% of members completed a prototype that advanced their careers.",
                    rationale: "This statistic focuses on economic outcomes rather than access to technology.",
                    isCorrect: false
                  },
                  {
                    text: "Most makerspaces partner with public libraries to cover evening access and offer sliding-scale pricing.",
                    rationale: "Correct. These strategies directly address the barriers that critics say prevent people from using the technology.",
                    isCorrect: true
                  },
                  {
                    text: "City planners include makerspaces in long-term development plans.",
                    rationale: "This highlights future investment, not the immediate issue of access.",
                    isCorrect: false
                  }
                ]
              },
                ...
                answerOptions: [
                  {
                    ...
                    rationale: "Weekend events are mentioned later as a response to critics, not as the main statistic shared with employers.",
                    isCorrect: false
                  },
                  {
                    text: "The percentage of members who completed prototypes that led to promotions or business launches.",
                    rationale: "Correct. Workforce boards cite the 62% success rate to convince employers to fund memberships.",
                    isCorrect: true
                  },
                  {
                    text: "The amount of grant money city planners allocate for transit projects.",
                    rationale: "Transit funding appears only in the final paragraph, unrelated to employer pitches.",
                    isCorrect: false
                  },
                  {
                    text: "The increase in teenage participation during the first year of operation.",
                    rationale: "Teen participation is discussed in paragraph four, not in the context of employer outreach.",
                    isCorrect: false
                  }
                ]
              },
                ...
                answerOptions: [
                  {
                    ...
                    rationale: "Correct. 'Nascent entrepreneurs' are individuals who are just starting to build their businesses.",
                    isCorrect: true
                  },
                  {
                    text: "highly profitable.",
                    rationale: "Nothing in the paragraph suggests that the entrepreneurs are already profitable.",
                    isCorrect: false
                  },
                  {
                    text: "reluctant to collaborate.",
                    rationale: "The paragraph emphasizes collaboration, not reluctance.",
                    isCorrect: false
                  },
                  {
                    text: "fully certified.",
                    rationale: "Certification is not mentioned in the description of the entrepreneurs.",
                    isCorrect: false
                  }
                ]
              },
                ...
                answerOptions: [
                  {
                    ...
                    rationale: "Correct. The author acknowledges challenges but ultimately views makerspaces as beneficial when supported.",
                    isCorrect: true
                  },
                  {
                    text: "They are risky experiments that should be paused until more research exists.",
                    rationale: "The author never recommends halting makerspace programs.",
                    isCorrect: false
                  },
                  {
                    text: "They benefit hobbyists but offer little value to local economies.",
                    rationale: "The article repeatedly references economic gains and workforce development.",
                    isCorrect: false
                  },
                  {
                    text: "They should replace all existing workforce programs immediately.",
                    rationale: "The author presents makerspaces as complementary, not as replacements for every program.",
                    isCorrect: false
                  }
                ]
              },
                ...
                answerOptions: [
                  {
                    ...
                    rationale: "The instructor notes that the outreach doubled teenage participation, showing the events are effective, not unnecessary.",
                    isCorrect: false
                  },
                  {
                    text: "To illustrate the concrete results of the accessibility changes makerspaces implemented.",
                    rationale: "Correct. The quote demonstrates how policy changes led to measurable growth among teens.",
                    isCorrect: true
                  },
                  {
                    text: "To argue that only teenagers benefit from makerspaces.",
                    rationale: "Teens are one example; other groups are discussed throughout the article.",
                    isCorrect: false
                  },
                  {
                    text: "To criticize public libraries for charging fees.",
                    rationale: "Libraries are described as partners that expand access, not as obstacles.",
                    isCorrect: false
                  }
                ]
              },
                ...
                answerOptions: [
                  {
                    ...
                    rationale: "The article states the opposite: makerspaces offer access to expensive equipment.",
                    isCorrect: false
                  },
                  {
                    text: "Membership costs and specialized tools may still exclude marginalized residents.",
                    rationale: "Correct. Paragraph four summarizes this criticism before explaining how spaces responded.",
                    isCorrect: true
                  },
                  {
                    text: "They rely entirely on volunteer instructors with no professional experience.",
                    rationale: "Mentors are mentioned, but there is no criticism about expertise.",
                    isCorrect: false
                  },
                  {
                    text: "They focus on art projects instead of job training.",
                    rationale: "The article emphasizes workforce and entrepreneurship benefits, not a lack of job focus.",
                    isCorrect: false
                  }
                ]
              },
                ...
                answerOptions: [
                  {
                    ...
                    rationale: "Correct. The article explicitly says weekend events are meant to include these groups.",
                    isCorrect: true
                  },
                  {
                    text: "Retirees looking for advanced certification programs.",
                    rationale: "Retirees are mentioned as mentors, not as the target audience for weekend programming.",
                    isCorrect: false
                  },
                  {
                    text: "Out-of-state entrepreneurs scouting locations.",
                    rationale: "No evidence suggests the events are aimed at visiting entrepreneurs.",
                    isCorrect: false
                  },
                  {
                    text: "City planners drafting transit budgets.",
                    rationale: "Transit planning appears later and is unrelated to open houses.",
                    isCorrect: false
                  }
                ]
              },
                ...
                answerOptions: [
                  {
                    ...
                    rationale: "City planners are integrating makerspaces into long-term plans, suggesting continuity rather than disappearance.",
                    isCorrect: false
                  },
                  {
                    text: "Their success depends on being viewed as part of broader infrastructure investments.",
                    rationale: "Correct. The paragraph notes that planners place makerspaces alongside broadband and transit to secure sustained funding.",
                    isCorrect: true
                  },
                  {
                    text: "They will replace the need for broadband or transportation improvements.",
                    rationale: "The author says makerspaces are listed alongside these projects, not as replacements.",
                    isCorrect: false
                  },
                  {
                    text: "They will no longer require instructor stipends to operate effectively.",
                    rationale: "The paragraph explicitly recommends funding instructor stipends to keep spaces viable.",
                    isCorrect: false
                  }
                ]
              },
                ...
                answerOptions: [
                  {
                    ...
                    rationale: "This sentence speaks to motivation, not economic impact.",
                    isCorrect: false
                  },
                  {
                    text: "Members can attend scheduled trainings but are also free to work alongside mentors.",
                    rationale: "This detail explains the format of the makerspace, not its economic effect.",
                    isCorrect: false
                  },
                  {
                    ...
                    rationale: "Correct. The statistic directly links makerspace participation to promotions and new businesses.",
                    isCorrect: true
                  },
                  {
                    text: "One robotics instructor noted that outreach changes doubled teenage participation in less than a year.",
                    rationale: "This sentence describes access for teens, not economic growth.",
                    isCorrect: false
                  }
                ]
              }
  ...
  Workforce: {
    ...
    categories: {
      "Career Readiness": {
        description: "Explore workforce readiness tools, career prep, and skill-building modules",
        topics: [
          {
            id: "resume_builder",
            title: "Resume Builder",
            description: "Create and customize professional resumes for job applications.",
            type: "tool"
          },
          {
            id: "interview_prep",
          ...
          },
          {
            ...
            description: "Evaluate your workplace skills and identify areas for growth.",
            type: "assessment"
          }
        ]
      }
...
if (typeof window !== "undefined") {
  window.RLA_QUESTIONS = RLA_QUESTIONS;
}
if (typeof window !== "undefined") {
  window.RLA_QUESTIONS = RLA_QUESTIONS;
}
...
//# sourceMappingURL=rlaQuestions-F-MXPHaR.js.map
