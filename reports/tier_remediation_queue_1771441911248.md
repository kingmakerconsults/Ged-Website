...
- Generated: 2026-02-18T19:11:51.246Z
- Source audit: tier_progression_audit_1771441907060.json
- Mode: report-only-manual-review
- Totals: files=10, questions=4382, warnings=644, structural=22

## Subject Priority
- Math: score=1034, warnings=278, structural=1, files=2
- Social Studies: score=632, warnings=143, structural=19, files=3
...
- public\quizzes\math.quizzes.part2.json (Math) — score=552, warnings=150, structural=1, reason=question complexity appears below topic tier
...
- public\quizzes\social-studies.quizzes.part2.json (Social Studies) — score=468, warnings=117, structural=0, reason=question complexity appears below topic tier
...
- public\quizzes\math.quizzes.part2.json (Math) — complexityFlags=123, action=Manual content rewrite: remove filler and increase multi-step reasoning per tier rubric.
...
- public\quizzes\social-studies.quizzes.part2.json (Social Studies) — complexityFlags=117, action=Manual content rewrite: remove filler and increase multi-step reasoning per tier rubric.
