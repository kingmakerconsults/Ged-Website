...
- Generated: 2026-02-18T18:10:01.325Z
- Source audit: tier_progression_audit_1771438200020.json
- Mode: report-only-manual-review
- Totals: files=10, questions=4382, warnings=696, structural=22

## Subject Priority
- Math: score=1162, warnings=310, structural=1, files=2
- Social Studies: score=712, warnings=163, structural=19, files=3
...
- public\quizzes\math.quizzes.part1.json (Math) — score=582, warnings=153, structural=0, reason=question complexity appears below topic tier
...
- public\quizzes\social-studies.quizzes.part2.json (Social Studies) — score=548, warnings=137, structural=0, reason=question complexity appears below topic tier
...
- public\quizzes\social-studies.quizzes.part2.json (Social Studies) — complexityFlags=137, action=Manual content rewrite: remove filler and increase multi-step reasoning per tier rubric.
