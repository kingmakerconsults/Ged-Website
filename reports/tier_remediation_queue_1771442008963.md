...
- Generated: 2026-02-18T19:13:28.962Z
- Source audit: tier_progression_audit_1771442008414.json
- Mode: report-only-manual-review
- Totals: files=10, questions=4382, warnings=606, structural=22

## Subject Priority
- Math: score=890, warnings=242, structural=1, files=2
...
- public\quizzes\math.quizzes.part1.json (Math) — score=410, warnings=110, structural=0, reason=question complexity appears below topic tier
