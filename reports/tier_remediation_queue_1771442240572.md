...
- Generated: 2026-02-18T19:17:20.571Z
- Source audit: tier_progression_audit_1771442240212.json
- Mode: report-only-manual-review
- Totals: files=10, questions=4382, warnings=702, structural=22

## Subject Priority
- Math: score=1022, warnings=308, structural=1, files=2
- Social Studies: score=660, warnings=171, structural=19, files=3
...
- public\quizzes\math.quizzes.part2.json (Math) — score=546, warnings=165, structural=1, reason=question complexity appears below topic tier
- public\quizzes\social-studies.quizzes.part2.json (Social Studies) — score=496, warnings=145, structural=0, reason=question complexity appears below topic tier
- public\quizzes\math.quizzes.part1.json (Math) — score=476, warnings=143, structural=0, reason=question complexity appears below topic tier
