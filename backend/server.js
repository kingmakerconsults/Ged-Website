...
app.post('/generate-quiz', async (req, res) => {
    ...
    if (comprehensive) {
        ...
        const comprehensivePrompts = {
            "Social Studies": `Generate a 35-question comprehensive GED Social Studies exam. Adhere to this content distribution: 50% Civics & Government, 20% U.S. History, 15% Economics, and 15% Geography & the World. All questions must be stimulus-based. For any passages that contain data tables, format them as a simple HTML <table>. Never describe or include URLs for images.`,
            "Science": `Generate a 38-question comprehensive GED Science exam. Adhere to this content distribution: 40% Life Science, 40% Physical Science, and 20% Earth & Space Science. Questions must test scientific practices. Include two 'short-answer' questions. For any passages that contain data tables, format them as a simple HTML <table>. Never describe or include URLs for images.`,
            "Mathematical Reasoning": `Generate a 46-question comprehensive GED Mathematical Reasoning exam in two parts. Part 1 (No Calculator): Generate the first 5 questions testing number sense, estimation, and basic operations that must be solved without a calculator. Part 2 (Calculator Allowed): Generate the remaining 41 questions. Adhere to this content distribution: 55% algebraic problems and 45% quantitative problems. For any passages that contain data tables, format them as a simple HTML <table>. Never describe or include URLs for images.`,
            "Reasoning Through Language Arts (RLA)": `Generate a comprehensive, 45-question GED RLA exam. The passages must be 75% informational text and 25% literary text. The final question must be an Extended Response (essay) task. The essay task must present two opposing passages on a contemporary issue and prompt the user to write an essay analyzing the arguments and determining which is better supported, using evidence from the text. This essay portion has a 45-minute time limit. For any passages that contain data tables, format them as a simple HTML <table>. Never describe or include URLs for images.`
        };
