  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        ...
        rationale:
          'Incorrect. Treaty-making is an enumerated federal power exercised by the President with Senate consent (Article II); states are constitutionally barred from entering treaties.',
        isCorrect: false,
      },
      {
        text: 'Maintaining an army and a navy.',
        rationale:
          'Incorrect. Raising and supporting the armed forces is an enumerated power of Congress (Article I, Section 8), so it belongs to the federal government, not the states.',
        isCorrect: false,
      },
    ],
  },
