...
module.exports = [
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "8:7",
        "isCorrect": true,
        "rationale": "The ratio is 16:14, which simplifies to 8:7 by dividing both by 2."
      },
      {
        "text": "16:30",
        "isCorrect": false,
    ...
    "answerOptions": [
      {
        "text": "60 feet",
        "isCorrect": true,
        "rationale": "The actual length is 10 * 72 = 720 inches. To convert to feet, divide by 12: 720 / 12 = 60 feet."
      },
      {
        "text": "72 feet",
        "isCorrect": false,
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "50",
        "isCorrect": true,
        "rationale": "A 150% increase means the new number is 250% of the original. 2.50 * 20 = 50. Or, the increase is 1.50*20=30, so the new number is 20+30=50."
      },
      {
        "text": "200",
        "isCorrect": false,
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "17.5 hours",
        "isCorrect": true,
        "rationale": "The rate is 5 hours / 2 miles = 2.5 hours per mile. For 7 miles, it will take 7 * 2.5 = 17.5 hours."
      },
      {
        "text": "20 hours",
        "isCorrect": false,
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "$0.30",
        "isCorrect": true,
        "rationale": "Divide the total cost by the number of ounces: $3.60 / 12 oz = $0.30/oz."
      },
      {
        "text": "$0.36",
        "isCorrect": false,
