module.exports = [
  ...
  },
  {
    ...
    rationale: 'To find the y-intercept, set x=0. f(0) = 0^2 - 9 = -9.',
    challenge_tags: ['math-1'],
  },
  {
    questionNumber: 6,
  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        text: '(-1, -2)',
        isCorrect: true,
        rationale: 'The vertex form y=(x-h)^2+k gives the vertex (h,k).',
      },
      {
        text: '(1, 2)',
        isCorrect: false,
    ...
    rationale:
      'The vertex form of a parabola is y = a(x - h)^2 + k, where the vertex is (h, k). In this equation, h = -1 and k = -2.',
    challenge_tags: ['math-1'],
  },
  {
    questionNumber: 9,
