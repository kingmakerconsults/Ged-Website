...
module.exports = [
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "10",
        "isCorrect": true,
        "rationale": "First, order the numbers: 8, 8, 10, 12, 14. The median is the middle number, 10."
      },
      {
        "text": "10.4",
        "isCorrect": false,
    ...
    "answerOptions": [
      {
        "text": "10",
        "isCorrect": true,
        "rationale": "This is a combination problem. The formula is n! / (k!(n-k)!). 5! / (2!(3!)) = 120 / (2*6) = 10."
      },
      {
        "text": "20",
        "isCorrect": false,
