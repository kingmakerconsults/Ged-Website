module.exports = [
  ...
  },
  {
    ...
    rationale:
      'To compare, convert all values to decimals: $\\frac{1}{3}$ â‰ˆ 0.333, 40% = 0.4. The smallest value is 0.333..., which is $\\frac{1}{3}$.',
    challenge_tags: ['math-1'],
  },
  {
    questionNumber: 6,
  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        ...
        isCorrect: true,
        rationale:
          'The ratio is 24 cookies / 1.5 cups. With 1 cup, you can make ($\\frac{1}{1}$.5)*24 = 16 cookies.',
      },
      {
        text: '18',
        isCorrect: false,
