...
module.exports = [
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "-8",
        "isCorrect": true,
        "rationale": "The y-intercept is the value of the function when x=0. f(0) = -8."
      },
      {
        "text": "2",
        "isCorrect": false,
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "2",
        "isCorrect": true,
        "rationale": "Slope = (change in y) / (change in x) = (9 - 3) / (2 - (-1)) = 6 / 3 = 2."
      },
      {
        "text": "3",
        "isCorrect": false,
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "C(m) = 50 + 0.25m",
        "isCorrect": true,
        "rationale": "The total cost is the fixed fee plus the variable cost per mile."
      },
      {
        "text": "C(m) = (50 + 0.25)m",
        "isCorrect": false,
    ...
    "answerOptions": [
      {
        "text": "x > 2",
        "isCorrect": false,
        "rationale": "The value under the square root can be zero, so x can be equal to 2."
      },
      {
        "text": "x geq 2",
        "isCorrect": true,
        "rationale": "The expression under a square root must be non-negative. So, x - 2 >= 0, which means x >= 2."
      },
      {
        "text": "All real numbers",
        "isCorrect": false,
        "rationale": "If x < 2, the value under the square root would be negative."
      },
      {
        "text": "x leq 2",
        "isCorrect": false,
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "y = -2x + 4",
        "isCorrect": true,
        "rationale": "The y-intercept is 4. The slope is (0-4)/(2-0) = -2. So, y = -2x + 4."
      },
      {
        "text": "y = -2x + 2",
        "isCorrect": false,
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        ...
        "isCorrect": true,
        "rationale": "The $x^2$ term means it's a parabola opening upward. The -1 shifts the vertex down one unit from the origin."
      },
      {
