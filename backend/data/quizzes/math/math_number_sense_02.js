module.exports = [
  {
    ...
    rationale:
      'To compare the fractions, find a common denominator, which is 8. The fractions become $\\frac{4}{8}$, $\\frac{3}{8}$, $\\frac{5}{8}$, and $\\frac{2}{8}$. The largest is $\\frac{5}{8}$.',
  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        ...
        isCorrect: true,
        rationale:
          'To divide by a fraction, multiply by its reciprocal: $\\frac{2}{3}$ * $\\frac{4}{1}$ = $\\frac{8}{3}$.',
      },
      {
        text: '$\\frac{2}{12}$',
        isCorrect: false,
