  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        ...
        isCorrect: false,
        rationale:
          'Incorrect. "\\(\\frac{1}{5}\\)" does not match the result of the correct calculation for this problem.',
      },
      {
        text: '\\(\\frac{5}{10}\\)',
        isCorrect: false,
        rationale:
          'Incorrect. "\\(\\frac{5}{10}\\)" does not match the result of the correct calculation for this problem.',
      },
      {
        text: '\\(\\frac{1}{15}\\)',
        isCorrect: false,
