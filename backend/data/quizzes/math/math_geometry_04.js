    ...
    answerOptions: [
      {
        ...
        isCorrect: true,
        rationale:
          'Using the Pythagorean theorem, 5^2 + 12^2 = 25 + 144 = 169. The square root of 169 is 13.',
      },
      {
        text: '17 cm',
        isCorrect: false,
  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        text: '64 cm^3',
        isCorrect: true,
        rationale: 'Volume of a cube is side^3. 4^3 = 4 * 4 * 4 = 64.',
      },
    ],
    rationale:
