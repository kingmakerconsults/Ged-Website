  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "The slope",
        "isCorrect": true,
        "rationale": "The coefficient of x, 'm', represents the slope of the line."
      },
      {
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "5",
        "isCorrect": true,
        "rationale": "Using the distance formula, sqrt($(4-1)^2 + (6-2)^2$) = sqrt($3^2 + 4^2$) = sqrt(9 + 16) = sqrt(25) = 5."
      },
      {
        "text": "7",
        "isCorrect": false,
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        ...
        "isCorrect": true,
        "rationale": "Exponential functions show growth or decay that is proportional to the current value."
      },
      {
        "text": "A V-shape",
        "isCorrect": false,
