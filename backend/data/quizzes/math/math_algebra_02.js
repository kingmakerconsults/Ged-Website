  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "10",
        "isCorrect": false,
        "rationale": "This is the result if you subtract 3 from 7 and then add 5."
      },
      {
        "text": "20",
        "isCorrect": true,
        "rationale": "Subtract 3 from both sides to get z/5 = 4, then multiply by 5 to get z = 20."
      },
      {
        "text": "50",
        "isCorrect": false,
    ...
    "answerOptions": [
      {
        "text": "1",
        "isCorrect": false,
        "rationale": "A slope of 1 means the line rises one unit for every one unit it runs."
      },
      {
        "text": "0",
        "isCorrect": true,
        "rationale": "A horizontal line has zero 'rise' for any 'run', so the slope is 0."
      },
      {
        "text": "Undefined",
        "isCorrect": false,
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "6",
        "isCorrect": true,
        "rationale": "Distribute on both sides: 5x - 10 = 2x + 8. Subtract 2x from both sides: 3x - 10 = 8. Add 10 to both sides: 3x = 18. Divide by 3: x = 6."
      },
      {
        "text": "9",
        "isCorrect": false,
    ...
    "answerOptions": [
      {
        "text": "x leq -4",
        "isCorrect": false,
        "rationale": "The inequality sign should be reversed when dividing by a negative number."
      },
      {
        "text": "x geq -4",
        "isCorrect": true,
        "rationale": "Subtract 4: -3x <= 12. Divide by -3 and reverse the inequality sign: x >= -4."
      },
      {
        "text": "x leq 4",
        "isCorrect": false,
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "18 and 19",
        "isCorrect": true,
        "rationale": "Let the integers be n and n+1. n + (n+1) = 37. 2n + 1 = 37. 2n = 36. n = 18. The integers are 18 and 19."
      },
      {
        "text": "19 and 20",
        "isCorrect": false,
