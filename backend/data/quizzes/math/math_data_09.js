module.exports = [
  ...
  },
  {
    ...
    rationale:
      'To find the mean, add the numbers together (7 + 8 + 8 + 9 + 13 = 45) and divide by the number of values (5). \\(\\frac{45}{5}\\) = 9.',
    challenge_tags: ['math-6'],
  },
  {
    questionNumber: 4,
  ...
  },
  {
    ...
    rationale:
      "The difference between the student's score and the mean is 90 - 80 = 10. To find how many standard deviations this is, divide the difference by the standard deviation: \\(\\frac{10}{5}\\) = 2.",
    challenge_tags: ['math-6'],
  },
  {
    questionNumber: 7,
