  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        ...
        isCorrect: true,
        rationale:
          'A parallel line has the same slope (\\(\\frac{1}{2}\\)). A line passing through the origin has a y-intercept of 0.',
      },
      {
        text: '\\(y = 2x\\)',
        isCorrect: false,
    ...
    rationale:
      'A parallel line must have the same slope, which is \\(\\frac{1}{2}\\). A line that passes through the origin has a y-intercept of 0. So the equation is \\(y = \\frac{1}{2}x\\).',
    challenge_tags: ['math-3'],
  },
  {
    questionNumber: 9,
