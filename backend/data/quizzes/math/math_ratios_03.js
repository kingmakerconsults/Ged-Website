  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        ...
        isCorrect: true,
        rationale:
          'There are 40 - 25 = 15 boys. The percentage is (\\(\\frac{15}{40}\\)) * 100 = 37.5%.',
      },
      {
        text: '60%',
        isCorrect: false,
    ...
    answerOptions: [
      {
        ...
        isCorrect: false,
        rationale:
          '\\(\\$1.50 \\div 3 = \\$0.50\\) per apple, which is more than the best deal of \\$0.45 per apple.',
      },
      {
      ...
      },
      {
        ...
        isCorrect: false,
        rationale:
          '\\(\\$2.50 \\div 5 = \\$0.50\\) per apple, more expensive per apple than the best deal of \\$0.45.',
      },
      {
        text: '2 apples for 1.00',
        isCorrect: false,
        rationale:
          '\\(\\$1.00 \\div 2 = \\$0.50\\) per apple, which is higher than the best deal of \\$0.45 per apple.',
      },
    ],
    rationale:
      'To find the best value, calculate the unit price per apple for each option: A) \\(\\$1.50 \\div 3 = \\$0.50\\)/apple, B) \\(\\$1.80 \\div 4 = \\$0.45\\)/apple, C) \\(\\$2.50 \\div 5 = \\$0.50\\)/apple, D) \\(\\$1.00 \\div 2 = \\$0.50\\)/apple. The lowest unit price is \\$0.45, so option B is the best value.',
    challenge_tags: ['math-1'],
  },
  {
    questionNumber: 12,
