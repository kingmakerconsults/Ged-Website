module.exports = [
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "$30",
        "isCorrect": true,
        "rationale": "The discount is 0.40 * $50 = $20. The sale price is $50 - $20 = $30."
      },
      {
        "text": "$70",
        "isCorrect": false,
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "$18700",
        "isCorrect": true,
        "rationale": "The depreciation is 0.15 * $22,000 = $3,300. The new value is $22,000 - $3,300 = $18,700."
      },
      {
        "text": "$20500",
        "isCorrect": false,
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "6",
        "isCorrect": true,
        "rationale": "Starting at -4 on a number line and moving 10 units to the right brings you to 6."
      },
      {
        "text": "14",
        "isCorrect": false,
  ...
  },
  {
    ...
    "calculator": true,
    "difficulty": "hard",
    "question": "You have \\(\\frac{3}{4}\\) of a pizza left. If you eat \\(\\frac{1}{3}\\) of the leftover pizza, what fraction of the original pizza did you eat?",
    "answerOptions": [
      {
        "text": "\\(\\frac{1}{4}\\)",
        "isCorrect": true,
    ...
    "answerOptions": [
      {
        "text": "134",
        "isCorrect": false,
        "rationale": "The sum of the digits is 1+3+4=8, which is not divisible by 3."
      },
      {
        "text": "205",
        "isCorrect": false,
        "rationale": "The sum of the digits is 2+0+5=7, which is not divisible by 3."
      },
      {
        "text": "312",
        "isCorrect": true,
