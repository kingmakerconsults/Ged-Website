module.exports = [
  ...
  },
  {
    ...
    rationale:
      'Using the formula for the volume of a cone, V = (\\(\\frac{1}{3}\\)) * pi * \\(r^{2}\\) * h. V = (\\(\\frac{1}{3}\\)) * 3.14 * (5 cm)^2 * 12 cm = (\\(\\frac{1}{3}\\)) * 3.14 * 25 * 12 = 314 cm^3.',
    challenge_tags: ['math-5'],
  },
  {
    questionNumber: 7,
    ...
    answerOptions: [
      {
        text: '25',
        isCorrect: true,
        rationale: '7^2 + 24^2 = 49 + 576 = 625. sqrt(625) = 25.',
      },
      {
        text: '31',
        isCorrect: false,
  ...
  },
  {
    ...
    answerOptions: [
      {
        ...
        isCorrect: true,
        rationale:
          'C = 2 * pi * r. 400 = 2 * 3.14 * r. 400 = 6.28 * r. r = \\(\\frac{400}{6}\\).28 ≈ 63.69, which is 64 to the nearest meter.',
      },
      {
        text: '127 meters',
        isCorrect: false,
    ...
    rationale:
      'The formula for circumference is C = 2 * pi * r. We have 400 = 2 * 3.14 * r. First, divide by (2 * 3.14): r = \\(\\frac{400}{6}\\).28 ≈ 63.69 meters. To the nearest meter, this is 64 meters.',
    challenge_tags: ['math-5'],
  },
];
