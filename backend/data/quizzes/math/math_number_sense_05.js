...
module.exports = [
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "2500",
        "isCorrect": true,
        "rationale": "Multiplying by 100 adds two zeros to the end of the number."
      },
      {
        "text": "25000",
        "isCorrect": false,
    ...
    "answerOptions": [
      {
        "text": "$6.25",
        "isCorrect": true,
        "rationale": "The total cost is $3.50 + $8.25 + $12.00 = $23.75. The change is $30.00 - $23.75 = $6.25."
      },
      {
        "text": "$7.75",
        "isCorrect": false,
    ...
    "answerOptions": [
      {
        "text": "-5, -2, 0, 3",
        "isCorrect": true,
        "rationale": "On a number line, numbers increase from left to right. -5 is the smallest, followed by -2, 0, and then 3."
      },
      {
        "text": "0, -2, -5, 3",
        "isCorrect": false,
    ...
    "answerOptions": [
      {
        "text": "$69.30",
        "isCorrect": true,
        "rationale": "Monday: $75 * (1 - 0.12) = $66. Tuesday: $66 * (1 + 0.05) = $69.30."
      },
      {
        "text": "$70.88",
        "isCorrect": false,
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "$2400",
        "isCorrect": true,
        "rationale": "Weekly income is 40 * $15 = $600. Monthly income is $600 * 4 = $2400."
      },
      {
        "text": "$3000",
        "isCorrect": false,
