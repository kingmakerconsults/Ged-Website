  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        ...
        isCorrect: true,
        rationale:
          'The GCF of 12 and 18 is 6. The GCF of xÂ² and x is x. So, the GCF is 6x.',
      },
      {
        text: '$3x$',
        isCorrect: false,
    ...
    rationale:
      'Find the GCF of the coefficients (12 and 18), which is 6. Find the GCF of the variables (xÂ² and x), which is x. Combine them to get 6x.',
    challenge_tags: ['math-3'],
  },
  {
    questionNumber: 9,
