module.exports = [
  ...
  },
  {
    ...
    difficulty: 'medium',
    question:
      'For the function \\(f(x) = 100(2)^x\\), find the value of \\(f(3)\\).',
    correctAnswer: '800',
  ...
  },
  {
    ...
    difficulty: 'medium',
    question:
      'Which point is the vertex of the parabola \\(y = (x-5)^2 + 1\\)?',
    answerOptions: [
      {
        text: '(-5, 1)',
        isCorrect: false,
      ...
      },
      {
        ...
        isCorrect: true,
        rationale:
          'The vertex form is y = (x-h)^2 + k, so the vertex is (h,k).',
      },
      {
        text: '(1, 5)',
        isCorrect: false,
