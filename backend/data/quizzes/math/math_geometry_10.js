  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "62.8 feet",
        "isCorrect": true,
        "rationale": "The circumference is 2 * 3.14 * 1 = 6.28 feet. For 10 rotations, the distance is 6.28 * 10 = 62.8 feet."
      },
      {
        "text": "10 feet",
        "isCorrect": false,
    ...
    "answerOptions": [
      {
        "text": "Rectangle",
        "isCorrect": false,
        "rationale": "A rectangle must have four right angles, but not necessarily equal sides."
      },
      {
        "text": "Rhombus",
        "isCorrect": true,
        "rationale": "A rhombus is defined as a quadrilateral with all four sides of equal length."
      },
      {
        "text": "Trapezoid",
        "isCorrect": false,
    ...
    "answerOptions": [
      {
        "text": "Congruent",
        "isCorrect": true,
        "rationale": "Corresponding angles are in the same position at each intersection and are equal."
      },
      {
        "text": "Supplementary",
        "isCorrect": false,
