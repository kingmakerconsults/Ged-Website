module.exports = [
  ...
  },
  {
    ...
    rationale:
      'First, find the price per pound: \\(3.00 \\div 5 = 0.60\\) per pound. Then multiply by the desired weight: \\(0.60 \\times 8 = 4.80\\).',
    challenge_tags: ['math-1'],
  },
  {
    questionNumber: 7,
  ...
  },
  {
    ...
    rationale:
      'Set up the proportion \\(\\frac{1}{25} = \\frac{20}{x}\\). Cross-multiply to find \\(x = 20 \\times 25 = 500\\).',
    challenge_tags: ['math-1'],
  },
  {
    questionNumber: 10,
  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        ...
        isCorrect: true,
        rationale:
          'The total ratio parts is 5. \\(\\frac{180}{5} = 36\\). The larger angle is \\(3 \\times 36 = 108\\).',
      },
      {
        text: '180°',
        isCorrect: false,
  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        text: '15/hour',
        isCorrect: true,
        rationale: 'Wage = \\(120 \\div 8 = 15\\) per hour.',
      },
      {
        text: '\\(20/hour\\)',
        isCorrect: false,
