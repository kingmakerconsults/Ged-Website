  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "523.33 $cm^3$",
        "isCorrect": true,
        "rationale": "V = (\\frac{4}{3}) * 3.14 * $5^3$ = 523.33."
      },
      {
        "text": "1256 $cm^3$",
        "isCorrect": false,
    ...
    "rationale": "Using the formula, V = ($\\frac{4}{3}$) * pi * $r^3$. V = ($\\frac{4}{3}$) * 3.14 * (5 cm)$^3$ = ($\\frac{4}{3}$) * 3.14 * 125 â‰ˆ 523.33 $cm^3$.",
    "challenge_tags": [
      "math-5"
    ]
  },
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "30",
        "isCorrect": true,
        "rationale": "The perimeter is the sum of the lengths of all sides: 5 + 7 + 8 + 10 = 30."
      },
      {
        "text": "2800",
        "isCorrect": false,
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      },
      {
        "text": "240",
        "isCorrect": true,
        "rationale": "Area of the triangular base = ($\\frac{1}{2}$)*6*8 = 24. Volume of the prism = base area * height = 24 * 10 = 240."
      },
      {
        "text": "480",
        "isCorrect": false,
      ...
      },
      {
        "text": "280",
        "isCorrect": false,
        "rationale": "This is the surface area of the two bases plus the area of one rectangular face."
      }
    ],
    "rationale": "First, find the area of the triangular base: A = $\\frac{1}{2}$ * base * height = $\\frac{1}{2}$ * 6 * 8 = 24. Then, multiply the base area by the height of the prism to find the volume: V = 24 * 10 = 240.",
    "challenge_tags": [
      "math-5"
    ]
  }
