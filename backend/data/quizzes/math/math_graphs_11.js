module.exports = [
  ...
  },
  {
    ...
    rationale:
      'The y-intercept of a function is the point where its graph crosses the y-axis, which occurs when x=0. For this function, f(0) = 0^2 - 4(0) + 3 = 3.',
    challenge_tags: ['math-3'],
  },
  {
    questionNumber: 7,
  ...
  },
  {
    ...
    difficulty: 'medium',
    question:
      'A function models the height of a ball, h(t) = -16t^2 + 32t, where t is time in seconds. What is the height of the ball at t=1 second?',
    correctAnswer: '16',
    rationale: 'h(1) = -16(1)^2 + 32(1) = -16 + 32 = 16.',
    challenge_tags: ['math-3'],
  },
  {
    questionNumber: 10,
