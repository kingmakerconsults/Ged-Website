...
module.exports = [
  {
    ...
    type: 'multipleChoice',
    question:
      'A triangle has a base of 8 units and a height of 6 units. What is its area?',
    answerOptions: [
      {
        text: '24 sq units',
        isCorrect: true,
      ...
      },
      {
        ...
        isCorrect: false,
        rationale:
          'Area of a triangle is \\(\\frac{1}{2} \\times \\text{base} \\times \\text{height}\\). \\(A = 0.5 \\times 8 \\times 6 = 24\\).',
      },
      {
        text: '30 sq units',
        isCorrect: false,
  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        ...
        isCorrect: true,
        rationale:
          'Volume of a cylinder is \\(\\pi r^{2} h\\). \\(V = 3.14 \\times 3^{2} \\times 10 = 282.6\\).',
      },
      {
  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        ...
        isCorrect: true,
        rationale:
          '\\(V = \\frac{4}{3} \\times 3.14 \\times 3^{3} = \\frac{4}{3} \\times 3.14 \\times 27 = 113.04\\).',
      },
      {
        text: '84.78 cubic cm',
        isCorrect: false,
    ...
    answerOptions: [
      {
        ...
        isCorrect: false,
        rationale:
          'Area formula: \\(A = \\frac{1}{2}bh\\). \\(30 = \\frac{1}{2}(10)h\\), so \\(30 = 5h\\) and \\(h = 6\\).',
      },
      {
        text: '6 meters',
        isCorrect: true,
  ...
  },
  {
    ...
    answerOptions: [
      ...
      },
      {
        ...
        isCorrect: false,
        rationale:
          'Area of a trapezoid is \\(\\frac{1}{2}h(b_1 + b_2)\\). \\(A = 0.5 \\times 6 \\times (8 + 12) = 60\\).',
      },
      {
        text: '9.42 cm',
        isCorrect: false,
