module.exports = [
  ...
  },
  {
    ...
    correctAnswer: '63',
    rationale:
      'The total ratio parts are 3+7=10. Each part represents \\(\\frac{90}{10}\\) = 9 animals. There are 7 parts dogs, so 7 * 9 = 63 dogs.',
    challenge_tags: ['math-1'],
  },
  {
    questionNumber: 8,
    ...
    answerOptions: [
      ...
      },
      {
        ...
        isCorrect: true,
        rationale:
          'Simplify \\(\\frac{9}{12}\\) to \\(\\frac{3}{4}\\). So \\(\\frac{x}{4} = \\frac{3}{4}\\), which means x = 3.',
      },
      {
        text: '4',
        isCorrect: false,
    ...
    rationale:
      'The fraction \\(\\frac{9}{12}\\) can be simplified to \\(\\frac{3}{4}\\). The proportion is then \\(\\frac{x}{4} = \\frac{3}{4}\\), which means x must be 3.',
    challenge_tags: ['math-1'],
  },
  {
    questionNumber: 9,
    ...
    rationale:
      'To paint 12 rooms, the painter needs to work 4 times as long as for 3 rooms (\\(\\frac{12}{3}\\) = 4). So, 5 hours * 4 = 20 hours.',
    challenge_tags: ['math-1'],
  },
  {
    questionNumber: 10,
