    ...
    answerOptions: [
      {
        ...
        rationale:
          "Incorrect. 'Currently raining' is an instant snapshot of conditions, which the passage defines as weather, not the long-term average that defines climate.",
        isCorrect: false,
      },
      {
      ...
      },
      {
        ...
        rationale:
          "Incorrect. Wind direction 'today' describes momentary atmospheric conditions — weather — not the long-term averaged pattern that constitutes climate.",
        isCorrect: false,
      },
    ],
  },
