...
const FLAGS = {
  ...
  ORG_INVITATIONS: { default: true,  description: 'Enable invitation system endpoints + tab' },
  ORG_BRANDING: { default: true,  description: 'Allow org admin to set logo/brand color' },
  ORG_USER_MANAGEMENT: { default: true,  description: 'Allow org admin to change role / remove / deactivate' },
  ORG_CSV_EXPORT: { default: true,  description: 'Enable CSV export endpoints' },

  // ---- Phase 3: instructor ----
  INSTRUCTOR_ROSTER_UI: { default: true,  description: 'Render real instructor roster instead of stub' },
  INSTRUCTOR_ASSIGNMENTS: { default: false, description: 'Enable assignment creation + tracking (UI not built yet)' },
  ...
  ONBOARDING_TOUR: { default: true,  description: 'Guided onboarding tour for new students' },
  ACCOUNT_SETTINGS_EXTENDED: { default: true,  description: 'Show password/email change in Settings' },
  ...
  RECOMMENDATIONS: { default: true,  description: 'Show "next recommended quiz" card' },

  // ---- Fresh-start (2026-04-28): org-gated onboarding ----
  ORG_GATED_ONBOARDING: { default: true,  description: 'Require org_admin approval before students can access content' },
