const templates = {
    table_typesOfRegions(meta) {
        return {
            stem: "Screenshot: Types of Regions. According to the table, which region type is organized around a central focus (a nodal or network region)?",
    ...
    chart_energy(meta) {
        return {
            stem: "According to the screenshot's line graph and legend, which energy source declines the most from 2000 to 2020?",
    ...
    table_branches(meta) {
        return {
            stem: "In the screenshot’s 'Branches of Government' table, which branch is listed with the power to evaluate laws?",
